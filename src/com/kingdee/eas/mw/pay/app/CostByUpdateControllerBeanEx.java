...
public class CostByUpdateControllerBeanEx extends com.kingdee.eas.mw.pay.app.CostByUpdateControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.mw.pay.app.CostByUpdateControllerBeanEx");
    protected void _auditCost(Context ctx, IObjectValue model)throws BOSException
    {
	     super._auditCost(ctx, model);
    }
    protected void _unAuditCost(Context ctx, IObjectValue model)throws BOSException
    {
	     super._unAuditCost(ctx, model);
    }
}				
