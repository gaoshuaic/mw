 ...
 * output class name
 */
public class DoctorPerformanceListUI extends AbstractDoctorPerformanceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DoctorPerformanceListUI.class);
    
    /**
     * output class constructor
     */
    public DoctorPerformanceListUI() throws Exception
    {
        super();
    }
