 ...
 * output class name
 */
public abstract class AbstractScalingTypeListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScalingTypeListUI.class);
    /**
     * output class constructor
     */
    public AbstractScalingTypeListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ScalingTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ScalingTypeListUI");
    }
