 ...
 * output class name
 */
public class AchRoyaltyRuleListUI extends AbstractAchRoyaltyRuleListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AchRoyaltyRuleListUI.class);
    
    /**
     * output class constructor
     */
    public AchRoyaltyRuleListUI() throws Exception
    {
        super();
    }
    @Override
