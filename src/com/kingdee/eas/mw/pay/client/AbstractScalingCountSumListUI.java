 ...
 * output class name
 */
public abstract class AbstractScalingCountSumListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScalingCountSumListUI.class);
    /**
     * output class constructor
     */
    public AbstractScalingCountSumListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ScalingCountSumListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ScalingCountSumListUI");
    }
