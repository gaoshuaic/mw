 ...
 * output class name
 */
public class DocCurrencyProEditUI extends AbstractDocCurrencyProEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DocCurrencyProEditUI.class);
    
    /**
     * output class constructor
     */
    public DocCurrencyProEditUI() throws Exception
    {
        super();
    }
    /**
