 ...
 * output class name
 */
public abstract class AbstractWhiteBonusUpdateEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWhiteBonusUpdateEditUI.class);
    ...
    protected com.kingdee.eas.mw.pay.WhiteBonusUpdateInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractWhiteBonusUpdateEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWhiteBonusUpdateEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtempNumber,txtempName,txtmbAchieve,txtclinicNumber,txtclinicName,txtbusinessDate,txtcityNumber,txtcityName,prmtcity,prmtclinic}));
    ...
    public void initUIContentLayout()
    {
        ...
        contmbAchieve.setBounds(new Rectangle(10, 34, 270, 19));
        ...
        contclinic.setBounds(new Rectangle(341, 106, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.WhiteBonusUpdateEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.WhiteBonusUpdateInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "WhiteBonusUpdateEditUI");
    }
