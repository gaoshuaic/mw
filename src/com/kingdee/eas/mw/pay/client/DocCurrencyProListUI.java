 ...
 * output class name
 */
public class DocCurrencyProListUI extends AbstractDocCurrencyProListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DocCurrencyProListUI.class);
    
    /**
     * output class constructor
     */
    public DocCurrencyProListUI() throws Exception
    {
        super();
    }
    @Override
