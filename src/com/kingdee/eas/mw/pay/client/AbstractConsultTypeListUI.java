 ...
 * output class name
 */
public abstract class AbstractConsultTypeListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractConsultTypeListUI.class);
    /**
     * output class constructor
     */
    public AbstractConsultTypeListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ConsultTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ConsultTypeListUI");
    }
