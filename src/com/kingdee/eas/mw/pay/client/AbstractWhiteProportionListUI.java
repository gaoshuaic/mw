 ...
 * output class name
 */
public abstract class AbstractWhiteProportionListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWhiteProportionListUI.class);
    /**
     * output class constructor
     */
    public AbstractWhiteProportionListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.WhiteProportionListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("mbNumber"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "WhiteProportionListUI");
    }
    ...
    {
        return com.kingdee.eas.mw.pay.client.WhiteProportionEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.WhiteProportionFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.WhiteProportionInfo objectValue = new com.kingdee.eas.mw.pay.WhiteProportionInfo();		
        return objectValue;
    }
