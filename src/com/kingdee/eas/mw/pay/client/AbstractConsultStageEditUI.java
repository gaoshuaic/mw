 ...
 * output class name
 */
public abstract class AbstractConsultStageEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractConsultStageEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contbeginAmount;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtbeginAmount;
    ...
    protected com.kingdee.eas.mw.pay.ConsultStageInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractConsultStageEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractConsultStageEditUI.class.getName());
        ...
        this.contbeginAmount = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtbeginAmount = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contbeginAmount.setName("contbeginAmount");
        ...
        this.txtbeginAmount.setName("txtbeginAmount");
        ...
        // contbeginAmount		
        this.contbeginAmount.setBoundLabelText(resHelper.getString("contbeginAmount.boundLabelText"));		
        this.contbeginAmount.setBoundLabelLength(100);		
        this.contbeginAmount.setBoundLabelUnderline(true);		
        this.contbeginAmount.setVisible(true);
        // contendAmount		
        ...
        // prmttype		
        this.prmttype.setQueryInfo("com.kingdee.eas.mw.pay.app.ConsultTypeQuery");		
        ...
        // txtbeginAmount		
        this.txtbeginAmount.setVisible(true);		
        this.txtbeginAmount.setHorizontalAlignment(2);		
        this.txtbeginAmount.setDataType(1);		
        this.txtbeginAmount.setSupportedEmpty(true);		
        this.txtbeginAmount.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtbeginAmount.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtbeginAmount.setPrecision(10);		
        this.txtbeginAmount.setRequired(false);
        // txtendAmount		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtcity,txtBusinessDate,prmttype,txtbeginAmount,txtendAmount,txtpro}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(341, 58, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(672, 58, 270, 19));
        ...
        contbeginAmount.setBounds(new Rectangle(10, 34, 270, 19));
        this.add(contbeginAmount, null);
        contendAmount.setBounds(new Rectangle(341, 34, 270, 19));
        this.add(contendAmount, null);
        contpro.setBounds(new Rectangle(672, 34, 270, 19));
        ...
        //contbeginAmount
        contbeginAmount.setBoundEditor(txtbeginAmount);
        //contendAmount
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("type", com.kingdee.eas.mw.pay.ConsultTypeInfo.class, this.prmttype, "data");
		dataBinder.registerBinding("beginAmount", java.math.BigDecimal.class, this.txtbeginAmount, "value");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ConsultStageEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.ConsultStageInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("beginAmount", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("beginAmount"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ConsultStageEditUI");
    }
    ...
    {
        return com.kingdee.eas.mw.pay.client.ConsultStageEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.ConsultStageFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.ConsultStageInfo objectValue = new com.kingdee.eas.mw.pay.ConsultStageInfo();
