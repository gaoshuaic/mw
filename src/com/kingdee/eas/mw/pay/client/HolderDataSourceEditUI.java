 ...
 * output class name
 */
public class HolderDataSourceEditUI extends AbstractHolderDataSourceEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(HolderDataSourceEditUI.class);
    
    /**
     * output class constructor
     */
    public HolderDataSourceEditUI() throws Exception
    {
        super();
    }
    /**
