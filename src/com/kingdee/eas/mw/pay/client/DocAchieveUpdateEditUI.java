 ...
 * output class name
 */
public class DocAchieveUpdateEditUI extends AbstractDocAchieveUpdateEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DocAchieveUpdateEditUI.class);
    
    /**
     * output class constructor
     */
    public DocAchieveUpdateEditUI() throws Exception
    {
        super();
    }
    /**
