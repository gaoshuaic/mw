 ...
 * output class name
 */
public class ClinicUpScaleListUI extends AbstractClinicUpScaleListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ClinicUpScaleListUI.class);
    
    /**
     * output class constructor
     */
    public ClinicUpScaleListUI() throws Exception
    {
        super();
    }
