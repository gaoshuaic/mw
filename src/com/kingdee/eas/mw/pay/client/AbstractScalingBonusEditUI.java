 ...
 * output class name
 */
public abstract class AbstractScalingBonusEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScalingBonusEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contjyNumber;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contcity;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contincludeDoc;
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox jyNumber;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtcity;
    protected com.kingdee.bos.ctrl.swing.KDComboBox includeDoc;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtbusinessDate;
    protected com.kingdee.eas.mw.pay.ScalingBonusInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractScalingBonusEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScalingBonusEditUI.class.getName());
        ...
        this.contjyNumber = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contcity = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contincludeDoc = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.jyNumber = new com.kingdee.bos.ctrl.swing.KDComboBox();
        this.prmtcity = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.includeDoc = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.contjyNumber.setName("contjyNumber");
        this.contcity.setName("contcity");
        this.contincludeDoc.setName("contincludeDoc");
        ...
        this.jyNumber.setName("jyNumber");
        this.prmtcity.setName("prmtcity");
        this.includeDoc.setName("includeDoc");
        ...
        // contjyNumber		
        this.contjyNumber.setBoundLabelText(resHelper.getString("contjyNumber.boundLabelText"));		
        this.contjyNumber.setBoundLabelLength(100);		
        this.contjyNumber.setBoundLabelUnderline(true);		
        this.contjyNumber.setVisible(true);
        // contcity		
        ...
        // contincludeDoc		
        this.contincludeDoc.setBoundLabelText(resHelper.getString("contincludeDoc.boundLabelText"));		
        this.contincludeDoc.setBoundLabelLength(100);		
        this.contincludeDoc.setBoundLabelUnderline(true);		
        this.contincludeDoc.setVisible(true);
        // contbusinessDate		
        ...
        // jyNumber		
        this.jyNumber.setVisible(true);		
        this.jyNumber.addItems(EnumUtils.getEnumList("com.kingdee.eas.mw.pay.app.jyType").toArray());		
        this.jyNumber.setRequired(false);
        // prmtcity		
        ...
        // includeDoc		
        this.includeDoc.setVisible(true);		
        this.includeDoc.addItems(EnumUtils.getEnumList("com.kingdee.eas.mw.pay.app.includeDoc").toArray());		
        this.includeDoc.setRequired(false);
        // txtbusinessDate		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtprice,txtcityNumber,txtcityName,jyNumber,prmtcity,includeDoc,txtbusinessDate}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(341, 34, 270, 19));
        ...
        contprice.setBounds(new Rectangle(672, 10, 270, 19));
        this.add(contprice, null);
        contcityNumber.setBounds(new Rectangle(341, 58, 270, 19));
        this.add(contcityNumber, null);
        contcityName.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(contcityName, null);
        contjyNumber.setBounds(new Rectangle(341, 10, 270, 19));
        this.add(contjyNumber, null);
        contcity.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contcity, null);
        contincludeDoc.setBounds(new Rectangle(10, 82, 270, 19));
        this.add(contincludeDoc, null);
        ...
        //contjyNumber
        contjyNumber.setBoundEditor(jyNumber);
        //contcity
        contcity.setBoundEditor(prmtcity);
        //contincludeDoc
        contincludeDoc.setBoundEditor(includeDoc);
        //contbusinessDate
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("jyNumber", com.kingdee.eas.mw.pay.app.jyType.class, this.jyNumber, "selectedItem");
		dataBinder.registerBinding("city", com.kingdee.eas.basedata.org.CtrlUnitInfo.class, this.prmtcity, "data");
		dataBinder.registerBinding("includeDoc", com.kingdee.eas.mw.pay.app.includeDoc.class, this.includeDoc, "selectedItem");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ScalingBonusEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.txtprice.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.ScalingBonusInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("jyNumber", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("jyNumber"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ScalingBonusEditUI");
    }
    ...
    {
        return com.kingdee.eas.mw.pay.client.ScalingBonusEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.ScalingBonusFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.ScalingBonusInfo objectValue = new com.kingdee.eas.mw.pay.ScalingBonusInfo();
