 ...
 * output class name
 */
public class DocAchieveUpdateListUI extends AbstractDocAchieveUpdateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DocAchieveUpdateListUI.class);
    
    /**
     * output class constructor
     */
    public DocAchieveUpdateListUI() throws Exception
    {
        super();
    }
