 ...
 * output class name
 */
public abstract class AbstractConsultKeepEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractConsultKeepEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contkeepBouns;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtkeepBouns;
    protected com.kingdee.eas.mw.pay.ConsultKeepInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractConsultKeepEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractConsultKeepEditUI.class.getName());
        ...
        this.contkeepBouns = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtkeepBouns = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contkeepBouns.setName("contkeepBouns");
        ...
        this.txtkeepBouns.setName("txtkeepBouns");
        // CoreUI		
        ...
        // contkeepBouns		
        this.contkeepBouns.setBoundLabelText(resHelper.getString("contkeepBouns.boundLabelText"));		
        this.contkeepBouns.setBoundLabelLength(100);		
        this.contkeepBouns.setBoundLabelUnderline(true);		
        this.contkeepBouns.setVisible(true);
        // txtNumber		
        ...
        // txtkeepBouns		
        this.txtkeepBouns.setVisible(true);		
        this.txtkeepBouns.setHorizontalAlignment(2);		
        this.txtkeepBouns.setDataType(1);		
        this.txtkeepBouns.setSupportedEmpty(true);		
        this.txtkeepBouns.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtkeepBouns.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtkeepBouns.setPrecision(10);		
        this.txtkeepBouns.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtempNumber,txtempName,txtclinicNumber,txtclinicName,txtbusinessDate,txtcityNumber,txtcityName,prmtcity,txtkeepBouns}));
    ...
    public void initUIContentLayout()
    {
        ...
        contkeepBouns.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(contkeepBouns, null);
        //kDLabelContainer1
        ...
        //contkeepBouns
        contkeepBouns.setBoundEditor(txtkeepBouns);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("keepBouns", java.math.BigDecimal.class, this.txtkeepBouns, "value");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ConsultKeepEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.ConsultKeepInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("keepBouns", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("keepBouns"));
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ConsultKeepEditUI");
    }
    ...
    {
        return com.kingdee.eas.mw.pay.client.ConsultKeepEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.ConsultKeepFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.ConsultKeepInfo objectValue = new com.kingdee.eas.mw.pay.ConsultKeepInfo();
