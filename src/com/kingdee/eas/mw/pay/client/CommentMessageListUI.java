 ...
 * output class name
 */
public class CommentMessageListUI extends AbstractCommentMessageListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CommentMessageListUI.class);
    
    /**
     * output class constructor
     */
    public CommentMessageListUI() throws Exception
    {
        super();
    }
