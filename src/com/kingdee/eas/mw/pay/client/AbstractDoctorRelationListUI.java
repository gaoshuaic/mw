 ...
 * output class name
 */
public abstract class AbstractDoctorRelationListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDoctorRelationListUI.class);
     ...
     */
    public AbstractDoctorRelationListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDoctorRelationListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.mw.pay.app", "DoctorRelationQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.DoctorRelationListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("assType"));
        sic.add(new SelectorItemInfo("assNumber"));
        sic.add(new SelectorItemInfo("assName"));
        sic.add(new SelectorItemInfo("businessDate"));
        sic.add(new SelectorItemInfo("remake"));
        sic.add(new SelectorItemInfo("importDate"));
        sic.add(new SelectorItemInfo("bili"));
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractDoctorRelationListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDoctorRelationListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "DoctorRelationListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.mw.pay.client.DoctorRelationEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.DoctorRelationFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.DoctorRelationInfo objectValue = new com.kingdee.eas.mw.pay.DoctorRelationInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","docNumber","docName","assType","assNumber","assName","businessDate","remake","importDate","bili","city.name"};
    }



	protected String getTDFileName() {
    	return "/bim/mw/pay/DoctorRelation";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.mw.pay.app.DoctorRelationQuery");
	}
