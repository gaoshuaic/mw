 ...
 * output class name
 */
public class ReferralBonusListUI extends AbstractReferralBonusListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ReferralBonusListUI.class);
    
    /**
     * output class constructor
     */
    public ReferralBonusListUI() throws Exception
    {
        super();
    }
