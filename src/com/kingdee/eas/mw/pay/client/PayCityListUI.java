...
public class PayCityListUI extends AbstractPayCityListUI
{
	...
	public void onLoad() throws Exception {
		...
		syncCostAndAchieve.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_listaccount"));// 图标
		
		syncMessage.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_syncpurview"));// 图标
		syncMessage.addActionListener(new ActionListener() {// 添加点击事件
			@Override
