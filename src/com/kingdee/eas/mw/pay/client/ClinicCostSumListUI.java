 ...
 * output class name
 */
public class ClinicCostSumListUI extends AbstractClinicCostSumListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ClinicCostSumListUI.class);
    
    /**
     * output class constructor
     */
    public ClinicCostSumListUI() throws Exception
    {
        super();
    }
