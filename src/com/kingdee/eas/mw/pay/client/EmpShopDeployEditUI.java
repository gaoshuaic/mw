 ...
 * output class name
 */
public class EmpShopDeployEditUI extends AbstractEmpShopDeployEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(EmpShopDeployEditUI.class);
    
    /**
     * output class constructor
     */
    public EmpShopDeployEditUI() throws Exception
    {
        super();
    }
    /**
