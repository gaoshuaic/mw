 ...
 * output class name
 */
public class ConsultantProEditUI extends AbstractConsultantProEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ConsultantProEditUI.class);
    
    /**
     * output class constructor
     */
    public ConsultantProEditUI() throws Exception
    {
        super();
    }
    /**
