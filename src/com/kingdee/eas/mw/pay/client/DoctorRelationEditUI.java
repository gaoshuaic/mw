 ...
 * output class name
 */
public class DoctorRelationEditUI extends AbstractDoctorRelationEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DoctorRelationEditUI.class);
    
    /**
     * output class constructor
     */
    public DoctorRelationEditUI() throws Exception
    {
        super();
    }
    /**
