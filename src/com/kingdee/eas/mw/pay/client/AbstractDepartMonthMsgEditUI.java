 ...
 * output class name
 */
public abstract class AbstractDepartMonthMsgEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDepartMonthMsgEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contbadNum;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtbadNum;
    ...
    protected com.kingdee.eas.mw.pay.DepartMonthMsgInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractDepartMonthMsgEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDepartMonthMsgEditUI.class.getName());
        ...
        this.contbadNum = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtbadNum = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contbadNum.setName("contbadNum");
        ...
        this.txtbadNum.setName("txtbadNum");
        ...
        // contbadNum		
        this.contbadNum.setBoundLabelText(resHelper.getString("contbadNum.boundLabelText"));		
        this.contbadNum.setBoundLabelLength(100);		
        this.contbadNum.setBoundLabelUnderline(true);		
        this.contbadNum.setVisible(true);
        // contimportDate		
        ...
        // txtbadNum		
        this.txtbadNum.setVisible(true);		
        this.txtbadNum.setHorizontalAlignment(2);		
        this.txtbadNum.setDataType(1);		
        this.txtbadNum.setSupportedEmpty(true);		
        this.txtbadNum.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtbadNum.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtbadNum.setPrecision(10);		
        this.txtbadNum.setRequired(false);
        // pkimportDate		
        ...
        this.status.addItems(EnumUtils.getEnumList("com.kingdee.eas.mw.pay.app.msgStatus").toArray());		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtmzNumber,txtmzName,txtbadNum,pkimportDate,txtbusinessDate,status,prmtcity,prmtclinic}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contCreator.setBounds(new Rectangle(10, 82, 270, 19));
        this.add(contCreator, null);
        contCreateTime.setBounds(new Rectangle(341, 82, 270, 19));
        this.add(contCreateTime, null);
        contLastUpdateUser.setBounds(new Rectangle(672, 82, 270, 19));
        this.add(contLastUpdateUser, null);
        contLastUpdateTime.setBounds(new Rectangle(10, 106, 270, 19));
        this.add(contLastUpdateTime, null);
        contNumber.setBounds(new Rectangle(341, 58, 270, 19));
        this.add(contNumber, null);
        contBizDate.setBounds(new Rectangle(672, 58, 270, 19));
        this.add(contBizDate, null);
        contDescription.setBounds(new Rectangle(672, 34, 270, 19));
        this.add(contDescription, null);
        contAuditor.setBounds(new Rectangle(10, 58, 270, 19));
        ...
        contbadNum.setBounds(new Rectangle(672, 10, 270, 19));
        this.add(contbadNum, null);
        contimportDate.setBounds(new Rectangle(10, 34, 270, 19));
        this.add(contimportDate, null);
        contbusinessDate.setBounds(new Rectangle(341, 34, 270, 19));
        this.add(contbusinessDate, null);
        contstatus.setBounds(new Rectangle(341, 106, 270, 19));
        this.add(contstatus, null);
        contcity.setBounds(new Rectangle(672, 106, 270, 19));
        ...
        //contbadNum
        contbadNum.setBoundEditor(txtbadNum);
        //contimportDate
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("badNum", java.math.BigDecimal.class, this.txtbadNum, "value");
		...
		dataBinder.registerBinding("status", com.kingdee.eas.mw.pay.app.msgStatus.class, this.status, "selectedItem");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.DepartMonthMsgEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.DepartMonthMsgInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("badNum", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("badNum"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "DepartMonthMsgEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.mw.pay.client.DepartMonthMsgEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.DepartMonthMsgFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.DepartMonthMsgInfo objectValue = new com.kingdee.eas.mw.pay.DepartMonthMsgInfo();
    	...
    	return "/bim/mw/pay/DepartMonthMsg";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.mw.pay.app.DepartMonthMsgQuery");
	}
