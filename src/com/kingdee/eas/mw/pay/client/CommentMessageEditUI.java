 ...
 * output class name
 */
public class CommentMessageEditUI extends AbstractCommentMessageEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CommentMessageEditUI.class);
    
    /**
     * output class constructor
     */
    public CommentMessageEditUI() throws Exception
    {
        super();
    }
    /**
