 ...
 * output class name
 */
public abstract class AbstractAchieveDetailTemEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAchieveDetailTemEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contdocAchieve;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contzxAchieve;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contcountAchieve;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtdocAchieve;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtzxAchieve;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtcountAchieve;
    protected com.kingdee.eas.mw.pay.AchieveDetailTemInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAchieveDetailTemEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAchieveDetailTemEditUI.class.getName());
        ...
        this.contdocAchieve = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contzxAchieve = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contcountAchieve = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtdocAchieve = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.txtzxAchieve = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.txtcountAchieve = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contdocAchieve.setName("contdocAchieve");
        this.contzxAchieve.setName("contzxAchieve");
        this.contcountAchieve.setName("contcountAchieve");
        ...
        this.txtdocAchieve.setName("txtdocAchieve");
        this.txtzxAchieve.setName("txtzxAchieve");
        this.txtcountAchieve.setName("txtcountAchieve");
        // CoreUI		
        ...
        // contdocAchieve		
        this.contdocAchieve.setBoundLabelText(resHelper.getString("contdocAchieve.boundLabelText"));		
        this.contdocAchieve.setBoundLabelLength(100);		
        this.contdocAchieve.setBoundLabelUnderline(true);		
        this.contdocAchieve.setVisible(true);
        // contzxAchieve		
        ...
        // contcountAchieve		
        this.contcountAchieve.setBoundLabelText(resHelper.getString("contcountAchieve.boundLabelText"));		
        this.contcountAchieve.setBoundLabelLength(100);		
        this.contcountAchieve.setBoundLabelUnderline(true);		
        this.contcountAchieve.setVisible(true);
        // prmtCreator		
        ...
        // txtdocAchieve		
        this.txtdocAchieve.setVisible(true);		
        this.txtdocAchieve.setHorizontalAlignment(2);		
        this.txtdocAchieve.setDataType(1);		
        this.txtdocAchieve.setSupportedEmpty(true);		
        this.txtdocAchieve.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtdocAchieve.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtdocAchieve.setPrecision(10);		
        this.txtdocAchieve.setRequired(false);
        // txtzxAchieve		
    ...
    {
        this.setBounds(new Rectangle(0, 0, 994, 509));
        this.setLayout(null);
        ...
        contbusinessDate.setBounds(new Rectangle(10, 442, 270, 19));
        this.add(contbusinessDate, null);
        contRecPersonNumber.setBounds(new Rectangle(334, 442, 270, 19));
        this.add(contRecPersonNumber, null);
        contdocAchieve.setBounds(new Rectangle(658, 442, 270, 19));
        this.add(contdocAchieve, null);
        contzxAchieve.setBounds(new Rectangle(10, 466, 270, 19));
        this.add(contzxAchieve, null);
        contcountAchieve.setBounds(new Rectangle(334, 466, 270, 19));
        this.add(contcountAchieve, null);
        //contCreator
        ...
        //contdocAchieve
        contdocAchieve.setBoundEditor(txtdocAchieve);
        //contzxAchieve
        contzxAchieve.setBoundEditor(txtzxAchieve);
        //contcountAchieve
        contcountAchieve.setBoundEditor(txtcountAchieve);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("docAchieve", java.math.BigDecimal.class, this.txtdocAchieve, "value");
		dataBinder.registerBinding("zxAchieve", java.math.BigDecimal.class, this.txtzxAchieve, "value");
		dataBinder.registerBinding("countAchieve", java.math.BigDecimal.class, this.txtcountAchieve, "value");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.AchieveDetailTemEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.AchieveDetailTemInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("docAchieve", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("zxAchieve", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("countAchieve", ValidateHelper.ON_SAVE);    		
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "AchieveDetailTemEditUI");
    }
    /**
