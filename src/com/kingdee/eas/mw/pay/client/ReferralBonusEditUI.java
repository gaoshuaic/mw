 ...
 * output class name
 */
public class ReferralBonusEditUI extends AbstractReferralBonusEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ReferralBonusEditUI.class);
    
    /**
     * output class constructor
     */
    public ReferralBonusEditUI() throws Exception
    {
        super();
    }
    /**
