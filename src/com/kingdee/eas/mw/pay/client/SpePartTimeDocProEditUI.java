 ...
 * output class name
 */
public class SpePartTimeDocProEditUI extends AbstractSpePartTimeDocProEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SpePartTimeDocProEditUI.class);
    
    /**
     * output class constructor
     */
    public SpePartTimeDocProEditUI() throws Exception
    {
        super();
    }
    /**
