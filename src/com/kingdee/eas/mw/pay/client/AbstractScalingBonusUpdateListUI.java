 ...
 * output class name
 */
public abstract class AbstractScalingBonusUpdateListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScalingBonusUpdateListUI.class);
    /**
     * output class constructor
     */
    public AbstractScalingBonusUpdateListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ScalingBonusUpdateListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ScalingBonusUpdateListUI");
    }
