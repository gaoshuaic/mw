 ...
 * output class name
 */
public class OtherBonusSpiltListUI extends AbstractOtherBonusSpiltListUI
{
    private static final Logger logger = CoreUIObject.getLogger(OtherBonusSpiltListUI.class);
    
    /**
     * output class constructor
     */
    public OtherBonusSpiltListUI() throws Exception
    {
        super();
    }
