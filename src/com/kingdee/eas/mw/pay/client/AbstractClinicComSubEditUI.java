 ...
 * output class name
 */
public abstract class AbstractClinicComSubEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractClinicComSubEditUI.class);
    ...
    protected com.kingdee.eas.mw.pay.ClinicComSubInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractClinicComSubEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractClinicComSubEditUI.class.getName());
        ...
        this.txtsubAmount.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtsubAmount.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtsubAmount.setPrecision(10);		
        this.txtsubAmount.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtempNumber,txtempName,txtclinicNumber,txtclinicName,postNumber,prmtclinic,prmtcity,txtbusinessdate,txtbadNum,txtsubAmount}));
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer3.setBounds(new Rectangle(341, 106, 270, 19));
        ...
        contclinicNumber.setBounds(new Rectangle(672, 58, 270, 19));
        this.add(contclinicNumber, null);
        contclinicName.setBounds(new Rectangle(10, 82, 270, 19));
        this.add(contclinicName, null);
        contpostNumber.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contpostNumber, null);
        contclinic.setBounds(new Rectangle(341, 10, 270, 19));
        this.add(contclinic, null);
        contcity.setBounds(new Rectangle(672, 82, 270, 19));
        this.add(contcity, null);
        contbusinessdate.setBounds(new Rectangle(10, 106, 270, 19));
        this.add(contbusinessdate, null);
        contbadNum.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(contbadNum, null);
        contsubAmount.setBounds(new Rectangle(341, 58, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ClinicComSubEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.ClinicComSubInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ClinicComSubEditUI");
    }
    ...
    {
        return com.kingdee.eas.mw.pay.client.ClinicComSubEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.ClinicComSubFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.ClinicComSubInfo objectValue = new com.kingdee.eas.mw.pay.ClinicComSubInfo();
