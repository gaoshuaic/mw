 ...
 * output class name
 */
public abstract class AbstractDocStageListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDocStageListUI.class);
    /**
     * output class constructor
     */
    public AbstractDocStageListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.DocStageListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "DocStageListUI");
    }
