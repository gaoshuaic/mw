 ...
 * output class name
 */
public abstract class AbstractHaopingMessageEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHaopingMessageEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contPraiseNum;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtPraiseNum;
    ...
    protected com.kingdee.eas.mw.pay.HaopingMessageInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractHaopingMessageEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHaopingMessageEditUI.class.getName());
        ...
        this.contPraiseNum = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtPraiseNum = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contPraiseNum.setName("contPraiseNum");
        ...
        this.txtPraiseNum.setName("txtPraiseNum");
        ...
        // contPraiseNum		
        this.contPraiseNum.setBoundLabelText(resHelper.getString("contPraiseNum.boundLabelText"));		
        this.contPraiseNum.setBoundLabelLength(100);		
        this.contPraiseNum.setBoundLabelUnderline(true);		
        this.contPraiseNum.setVisible(true);
        // contbusinessDate		
        ...
        // txtPraiseNum		
        this.txtPraiseNum.setVisible(true);		
        this.txtPraiseNum.setHorizontalAlignment(2);		
        this.txtPraiseNum.setDataType(1);		
        this.txtPraiseNum.setSupportedEmpty(true);		
        this.txtPraiseNum.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtPraiseNum.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtPraiseNum.setPrecision(10);		
        this.txtPraiseNum.setRequired(false);
        // txtbusinessDate		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtmzNumber,txtmzName,txtempNumber,txtempName,txtPraiseNum,txtbusinessDate,pkimportDate}));
    ...
    public void initUIContentLayout()
    {
        ...
        contPraiseNum.setBounds(new Rectangle(341, 34, 270, 19));
        this.add(contPraiseNum, null);
        ...
        //contPraiseNum
        contPraiseNum.setBoundEditor(txtPraiseNum);
        //contbusinessDate
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("PraiseNum", java.math.BigDecimal.class, this.txtPraiseNum, "value");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.HaopingMessageEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.HaopingMessageInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("PraiseNum", ValidateHelper.ON_SAVE);    
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "HaopingMessageEditUI");
    }
    /**
