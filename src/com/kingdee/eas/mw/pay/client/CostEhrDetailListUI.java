 ...
 * output class name
 */
public class CostEhrDetailListUI extends AbstractCostEhrDetailListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CostEhrDetailListUI.class);
    
    /**
     * output class constructor
     */
    public CostEhrDetailListUI() throws Exception
    {
        super();
    }
    ...
    /**
     * output actionSyncMiddata_actionPerformed
     */
    public void actionSyncMiddata_actionPerformed(ActionEvent e) throws Exception
    {
        super.actionSyncMiddata_actionPerformed(e);
    }
