 ...
 * output class name
 */
public class DocDetailBonusListUI extends AbstractDocDetailBonusListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DocDetailBonusListUI.class);
    
    /**
     * output class constructor
     */
    public DocDetailBonusListUI() throws Exception
    {
        super();
    }
