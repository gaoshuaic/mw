 ...
 * output class name
 */
public class ScalingCountSumEditUI extends AbstractScalingCountSumEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ScalingCountSumEditUI.class);
    
    /**
     * output class constructor
     */
    public ScalingCountSumEditUI() throws Exception
    {
        super();
    }
    /**
