 ...
 * output class name
 */
public class MarketDateEditUI extends AbstractMarketDateEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarketDateEditUI.class);
    
    /**
     * output class constructor
     */
    public MarketDateEditUI() throws Exception
    {
        super();
    }
    /**
