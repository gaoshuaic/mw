 ...
 * output class name
 */
public abstract class AbstractShopGoalBonusEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractShopGoalBonusEditUI.class);
    ...
    protected com.kingdee.eas.mw.pay.ShopGoalBonusInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractShopGoalBonusEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractShopGoalBonusEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtName,txtNumber,txtDescription,txtSimpleName,txtmoney}));
    ...
    public void initUIContentLayout()
    {
        ...
        contmoney.setBounds(new Rectangle(341, 34, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ShopGoalBonusEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.ShopGoalBonusInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ShopGoalBonusEditUI");
    }
