 ...
 * output class name
 */
public abstract class AbstractAttendanceHoursEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttendanceHoursEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contattrHours;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtattrHours;
    protected com.kingdee.bos.ctrl.swing.KDDatePicker pkimportDate;
    protected com.kingdee.eas.mw.pay.AttendanceHoursInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAttendanceHoursEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAttendanceHoursEditUI.class.getName());
        ...
        this.contattrHours = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtattrHours = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contattrHours.setName("contattrHours");
        ...
        this.txtattrHours.setName("txtattrHours");
        ...
        // contattrHours		
        this.contattrHours.setBoundLabelText(resHelper.getString("contattrHours.boundLabelText"));		
        this.contattrHours.setBoundLabelLength(100);		
        this.contattrHours.setBoundLabelUnderline(true);		
        this.contattrHours.setVisible(true);
        // contimportDate		
        ...
        // txtattrHours		
        this.txtattrHours.setVisible(true);		
        this.txtattrHours.setHorizontalAlignment(2);		
        this.txtattrHours.setDataType(1);		
        this.txtattrHours.setSupportedEmpty(true);		
        this.txtattrHours.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtattrHours.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtattrHours.setPrecision(10);		
        this.txtattrHours.setRequired(false);
        // pkimportDate		
        this.pkimportDate.setVisible(true);		
        this.pkimportDate.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtmzNumber,txtmzName,txtempNumber,txtempName,txtattrHours,txtbusinessDate,pkimportDate}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contCreator.setBounds(new Rectangle(341, 82, 270, 19));
        this.add(contCreator, null);
        contCreateTime.setBounds(new Rectangle(672, 82, 270, 19));
        this.add(contCreateTime, null);
        contLastUpdateUser.setBounds(new Rectangle(10, 106, 270, 19));
        this.add(contLastUpdateUser, null);
        contLastUpdateTime.setBounds(new Rectangle(341, 106, 270, 19));
        this.add(contLastUpdateTime, null);
        contNumber.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(contNumber, null);
        contBizDate.setBounds(new Rectangle(341, 58, 270, 19));
        this.add(contBizDate, null);
        contDescription.setBounds(new Rectangle(672, 58, 270, 19));
        this.add(contDescription, null);
        contAuditor.setBounds(new Rectangle(10, 82, 270, 19));
        ...
        contattrHours.setBounds(new Rectangle(341, 34, 270, 19));
        this.add(contattrHours, null);
        contimportDate.setBounds(new Rectangle(672, 106, 270, 19));
        ...
        //contattrHours
        contattrHours.setBoundEditor(txtattrHours);
        //contimportDate
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("attrHours", java.math.BigDecimal.class, this.txtattrHours, "value");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.AttendanceHoursEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.AttendanceHoursInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("attrHours", ValidateHelper.ON_SAVE);    
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "AttendanceHoursEditUI");
    }
    /**
