 ...
 * output class name
 */
public class PayShareDetailEditUI extends AbstractPayShareDetailEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PayShareDetailEditUI.class);
    
    /**
     * output class constructor
     */
    public PayShareDetailEditUI() throws Exception
    {
        super();
    }
    /**
