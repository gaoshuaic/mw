 ...
 * output class name
 */
public class ClinicAchieveCosthSumEditUI extends AbstractClinicAchieveCosthSumEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ClinicAchieveCosthSumEditUI.class);
    
    /**
     * output class constructor
     */
    public ClinicAchieveCosthSumEditUI() throws Exception
    {
        super();
    }
    /**
