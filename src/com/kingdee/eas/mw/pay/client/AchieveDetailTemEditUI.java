 ...
 * output class name
 */
public class AchieveDetailTemEditUI extends AbstractAchieveDetailTemEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AchieveDetailTemEditUI.class);
    
    /**
     * output class constructor
     */
    public AchieveDetailTemEditUI() throws Exception
    {
        super();
    }
    /**
