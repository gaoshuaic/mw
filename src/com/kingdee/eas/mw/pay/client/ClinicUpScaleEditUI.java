 ...
 * output class name
 */
public class ClinicUpScaleEditUI extends AbstractClinicUpScaleEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ClinicUpScaleEditUI.class);
    
    /**
     * output class constructor
     */
    public ClinicUpScaleEditUI() throws Exception
    {
        super();
    }
    /**
