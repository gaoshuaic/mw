 ...
 * output class name
 */
public class DoctorPerformanceEditUI extends AbstractDoctorPerformanceEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DoctorPerformanceEditUI.class);
    
    /**
     * output class constructor
     */
    public DoctorPerformanceEditUI() throws Exception
    {
        super();
    }
    /**
