 ...
 * output class name
 */
public class ScalingBonusUpdateEditUI extends AbstractScalingBonusUpdateEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ScalingBonusUpdateEditUI.class);
    
    /**
     * output class constructor
     */
    public ScalingBonusUpdateEditUI() throws Exception
    {
        super();
    }
    /**
