 ...
 * output class name
 */
public abstract class AbstractAchRoyaltyRuleListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAchRoyaltyRuleListUI.class);
    /**
     * output class constructor
     */
    public AbstractAchRoyaltyRuleListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.AchRoyaltyRuleListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "AchRoyaltyRuleListUI");
    }
