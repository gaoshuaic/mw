 ...
 * output class name
 */
public class PartTimeDocProListUI extends AbstractPartTimeDocProListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PartTimeDocProListUI.class);
    
    /**
     * output class constructor
     */
    public PartTimeDocProListUI() throws Exception
    {
        super();
    }
    @Override
