 ...
 * output class name
 */
public class DocStageEditUI extends AbstractDocStageEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DocStageEditUI.class);
    
    /**
     * output class constructor
     */
    public DocStageEditUI() throws Exception
    {
        super();
    }
    /**
