 ...
 * output class name
 */
public class DepartMonthMsgEditUI extends AbstractDepartMonthMsgEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DepartMonthMsgEditUI.class);
    
    /**
     * output class constructor
     */
    public DepartMonthMsgEditUI() throws Exception
    {
        super();
    }
    /**
