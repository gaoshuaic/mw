 ...
 * output class name
 */
public class AttendanceHoursEditUI extends AbstractAttendanceHoursEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AttendanceHoursEditUI.class);
    
    /**
     * output class constructor
     */
    public AttendanceHoursEditUI() throws Exception
    {
        super();
    }
    /**
