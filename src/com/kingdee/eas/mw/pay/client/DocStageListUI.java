 ...
 * output class name
 */
public class DocStageListUI extends AbstractDocStageListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DocStageListUI.class);
    
    /**
     * output class constructor
     */
    public DocStageListUI() throws Exception
    {
        super();
    }
