 ...
 * output class name
 */
public class ScalingCountSumListUI extends AbstractScalingCountSumListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ScalingCountSumListUI.class);
    
    /**
     * output class constructor
     */
    public ScalingCountSumListUI() throws Exception
    {
        super();
    }
