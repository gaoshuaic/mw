 ...
 * output class name
 */
public abstract class AbstractPayPostEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPayPostEditUI.class);
    ...
    protected com.kingdee.eas.mw.pay.PayPostInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractPayPostEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPayPostEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {status,txtpostName,txtempNumber,txtempName,txtclinicNumber,txtclinicName,postNumber,prmtclinic,prmtcity,txtbusinessdate}));
    ...
    public void initUIContentLayout()
    {
        ...
        contstatus.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(contstatus, null);
        contpostName.setBounds(new Rectangle(672, 82, 270, 19));
        ...
        contclinicNumber.setBounds(new Rectangle(10, 82, 270, 19));
        this.add(contclinicNumber, null);
        contclinicName.setBounds(new Rectangle(341, 82, 270, 19));
        ...
        contcity.setBounds(new Rectangle(10, 106, 270, 19));
        this.add(contcity, null);
        contbusinessdate.setBounds(new Rectangle(341, 106, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.PayPostEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.PayPostInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "PayPostEditUI");
    }
