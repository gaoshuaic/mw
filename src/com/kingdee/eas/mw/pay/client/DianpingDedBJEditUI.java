 ...
 * output class name
 */
public class DianpingDedBJEditUI extends AbstractDianpingDedBJEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DianpingDedBJEditUI.class);
    
    /**
     * output class constructor
     */
    public DianpingDedBJEditUI() throws Exception
    {
        super();
    }
    /**
