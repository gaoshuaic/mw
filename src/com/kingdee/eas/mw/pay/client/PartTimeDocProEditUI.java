 ...
 * output class name
 */
public class PartTimeDocProEditUI extends AbstractPartTimeDocProEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PartTimeDocProEditUI.class);
    
    /**
     * output class constructor
     */
    public PartTimeDocProEditUI() throws Exception
    {
        super();
    }
    /**
