 ...
 * output class name
 */
public abstract class AbstractSpecategoryEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSpecategoryEditUI.class);
    ...
    protected com.kingdee.eas.mw.pay.SpecategoryInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSpecategoryEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSpecategoryEditUI.class.getName());
        ...
        // kdtEntrys
		String kdtEntrysStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"number\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{id}</t:Cell><t:Cell>$Resource{number}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		
        this.kdtEntrys.setFormatXml(resHelper.translateString("kdtEntrys",kdtEntrysStrXML));

                this.kdtEntrys.putBindContents("editData",new String[] {"id","number"});
        ...
        this.kdtAssEntrys.setFormatXml(resHelper.translateString("kdtAssEntrys",kdtAssEntrysStrXML));
                ...
                this.kdtAssEntrys.putBindContents("editData",new String[] {"id","number"});


        this.kdtAssEntrys.checkParsed();
        KDTextField kdtAssEntrys_number_TextField = new KDTextField();
        kdtAssEntrys_number_TextField.setName("kdtAssEntrys_number_TextField");
        kdtAssEntrys_number_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtAssEntrys_number_CellEditor = new KDTDefaultCellEditor(kdtAssEntrys_number_TextField);
        this.kdtAssEntrys.getColumn("number").setEditor(kdtAssEntrys_number_CellEditor);
        // kdtOtherEntrys
        ...
        this.kdtOtherEntrys.setFormatXml(resHelper.translateString("kdtOtherEntrys",kdtOtherEntrysStrXML));
                ...
                this.kdtOtherEntrys.putBindContents("editData",new String[] {"id","number"});


        this.kdtOtherEntrys.checkParsed();
        KDTextField kdtOtherEntrys_number_TextField = new KDTextField();
        kdtOtherEntrys_number_TextField.setName("kdtOtherEntrys_number_TextField");
        kdtOtherEntrys_number_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtOtherEntrys_number_CellEditor = new KDTDefaultCellEditor(kdtOtherEntrys_number_TextField);
        this.kdtOtherEntrys.getColumn("number").setEditor(kdtOtherEntrys_number_CellEditor);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {kdtOtherEntrys,kdtAssEntrys,kDDateLastUpdateTime,prmtLastUpdateUser,kDDateCreateTime,prmtCreator,prmtAuditor,txtDescription,pkBizDate,txtNumber,kdtEntrys}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 1013, 564));
        this.setLayout(null);
        contCreator.setBounds(new Rectangle(351, 496, 270, 19));
        this.add(contCreator, null);
        contCreateTime.setBounds(new Rectangle(729, 496, 270, 19));
        this.add(contCreateTime, null);
        contLastUpdateUser.setBounds(new Rectangle(351, 527, 270, 19));
        this.add(contLastUpdateUser, null);
        contLastUpdateTime.setBounds(new Rectangle(729, 527, 270, 19));
        this.add(contLastUpdateTime, null);
        contNumber.setBounds(new Rectangle(12, 6, 270, 19));
        this.add(contNumber, null);
        contBizDate.setBounds(new Rectangle(351, 8, 270, 19));
        this.add(contBizDate, null);
        contDescription.setBounds(new Rectangle(725, 8, 270, 19));
        this.add(contDescription, null);
        contAuditor.setBounds(new Rectangle(13, 527, 270, 19));
        this.add(contAuditor, null);
        paneBIZLayerControl17.setBounds(new Rectangle(6, 36, 993, 448));
        ...
        //baseTab
        baseTab.setLayout(null);        kdtEntrys.setBounds(new Rectangle(6, 6, 975, 399));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.mw.pay.SpecategoryEntryInfo(),null,false);
        baseTab.add(kdtEntrys_detailPanel, null);
        //assTab
        assTab.setLayout(null);        kdtAssEntrys.setBounds(new Rectangle(5, 5, 979, 404));
        kdtAssEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtAssEntrys,new com.kingdee.eas.mw.pay.SpecategoryAssEntryInfo(),null,false);
        assTab.add(kdtAssEntrys_detailPanel, null);
        //otherTab
        otherTab.setLayout(null);        kdtOtherEntrys.setBounds(new Rectangle(6, 7, 977, 400));
        kdtOtherEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtOtherEntrys,new com.kingdee.eas.mw.pay.SpecategoryOtherEntryInfo(),null,false);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.mw.pay.SpecategoryEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("AssEntrys", com.kingdee.eas.mw.pay.SpecategoryAssEntryInfo.class, this.kdtAssEntrys, "userObject");
		dataBinder.registerBinding("AssEntrys.number", String.class, this.kdtAssEntrys, "number.text");
		dataBinder.registerBinding("OtherEntrys.id", com.kingdee.bos.util.BOSUuid.class, this.kdtOtherEntrys, "id.text");
		dataBinder.registerBinding("OtherEntrys", com.kingdee.eas.mw.pay.SpecategoryOtherEntryInfo.class, this.kdtOtherEntrys, "userObject");
		dataBinder.registerBinding("OtherEntrys.number", String.class, this.kdtOtherEntrys, "number.text");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.SpecategoryEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.kdtOtherEntrys.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.SpecategoryInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "SpecategoryEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.mw.pay.client.SpecategoryEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.SpecategoryFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.SpecategoryInfo objectValue = new com.kingdee.eas.mw.pay.SpecategoryInfo();
    	...
    	return "/bim/mw/pay/Specategory";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.mw.pay.app.SpecategoryQuery");
	}
