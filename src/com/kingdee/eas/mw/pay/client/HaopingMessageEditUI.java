 ...
 * output class name
 */
public class HaopingMessageEditUI extends AbstractHaopingMessageEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(HaopingMessageEditUI.class);
    
    /**
     * output class constructor
     */
    public HaopingMessageEditUI() throws Exception
    {
        super();
    }
    /**
