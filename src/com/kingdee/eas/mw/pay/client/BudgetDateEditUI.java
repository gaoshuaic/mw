 ...
 * output class name
 */
public class BudgetDateEditUI extends AbstractBudgetDateEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BudgetDateEditUI.class);
    
    /**
     * output class constructor
     */
    public BudgetDateEditUI() throws Exception
    {
        super();
    }
    /**
