 ...
 * output class name
 */
public abstract class AbstractAchienementSumListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAchienementSumListUI.class);
    /**
     * output class constructor
     */
    public AbstractAchienementSumListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.AchienementSumListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "AchienementSumListUI");
    }
