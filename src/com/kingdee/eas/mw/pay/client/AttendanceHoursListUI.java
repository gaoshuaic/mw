 ...
 * output class name
 */
public class AttendanceHoursListUI extends AbstractAttendanceHoursListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AttendanceHoursListUI.class);
    
    /**
     * output class constructor
     */
    public AttendanceHoursListUI() throws Exception
    {
        super();
    }
