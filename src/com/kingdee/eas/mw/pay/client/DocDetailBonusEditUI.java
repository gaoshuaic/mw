 ...
 * output class name
 */
public class DocDetailBonusEditUI extends AbstractDocDetailBonusEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DocDetailBonusEditUI.class);
    
    /**
     * output class constructor
     */
    public DocDetailBonusEditUI() throws Exception
    {
        super();
    }
    /**
