 ...
 * output class name
 */
public class DocHISBiLiListUI extends AbstractDocHISBiLiListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DocHISBiLiListUI.class);
    
    /**
     * output class constructor
     */
    public DocHISBiLiListUI() throws Exception
    {
        super();
    }
