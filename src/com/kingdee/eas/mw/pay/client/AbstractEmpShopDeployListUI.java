 ...
 * output class name
 */
public abstract class AbstractEmpShopDeployListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEmpShopDeployListUI.class);
    /**
     * output class constructor
     */
    public AbstractEmpShopDeployListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.EmpShopDeployListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "EmpShopDeployListUI");
    }
