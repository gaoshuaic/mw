 ...
 * output class name
 */
public class DoctorCostsEditUI extends AbstractDoctorCostsEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DoctorCostsEditUI.class);
    
    /**
     * output class constructor
     */
    public DoctorCostsEditUI() throws Exception
    {
        super();
    }
    /**
