 ...
 * output class name
 */
public class ClinicMonthSumListUI extends AbstractClinicMonthSumListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ClinicMonthSumListUI.class);
    
    /**
     * output class constructor
     */
    public ClinicMonthSumListUI() throws Exception
    {
        super();
    }
