 ...
 * output class name
 */
public class SpePartTimeDocProListUI extends AbstractSpePartTimeDocProListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SpePartTimeDocProListUI.class);
    
    /**
     * output class constructor
     */
    public SpePartTimeDocProListUI() throws Exception
    {
        super();
    }
