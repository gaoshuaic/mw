 ...
 * output class name
 */
public abstract class AbstractConsultantBonusUpdateEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractConsultantBonusUpdateEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contallGenAchieve;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contclinic;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contzpAchieve;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtallGenAchieve;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtclinic;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtzpAchieve;
    protected com.kingdee.eas.mw.pay.ConsultantBonusUpdateInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractConsultantBonusUpdateEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractConsultantBonusUpdateEditUI.class.getName());
        ...
        this.contallGenAchieve = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contclinic = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contzpAchieve = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtallGenAchieve = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.prmtclinic = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.txtzpAchieve = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contallGenAchieve.setName("contallGenAchieve");
        this.contclinic.setName("contclinic");
        this.contzpAchieve.setName("contzpAchieve");
        ...
        this.txtallGenAchieve.setName("txtallGenAchieve");
        this.prmtclinic.setName("prmtclinic");
        this.txtzpAchieve.setName("txtzpAchieve");
        // CoreUI		
        ...
        // contallGenAchieve		
        this.contallGenAchieve.setBoundLabelText(resHelper.getString("contallGenAchieve.boundLabelText"));		
        this.contallGenAchieve.setBoundLabelLength(100);		
        this.contallGenAchieve.setBoundLabelUnderline(true);		
        this.contallGenAchieve.setVisible(true);
        // contclinic		
        ...
        // contzpAchieve		
        this.contzpAchieve.setBoundLabelText(resHelper.getString("contzpAchieve.boundLabelText"));		
        this.contzpAchieve.setBoundLabelLength(100);		
        this.contzpAchieve.setBoundLabelUnderline(true);		
        this.contzpAchieve.setVisible(true);
        // txtNumber		
        ...
        // txtzxAchieve		
        this.txtzxAchieve.setVisible(true);		
        ...
        // txtallGenAchieve		
        this.txtallGenAchieve.setVisible(true);		
        this.txtallGenAchieve.setHorizontalAlignment(2);		
        this.txtallGenAchieve.setDataType(1);		
        this.txtallGenAchieve.setSupportedEmpty(true);		
        this.txtallGenAchieve.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtallGenAchieve.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtallGenAchieve.setPrecision(10);		
        this.txtallGenAchieve.setRequired(false);
        // prmtclinic		
        ...
        // txtzpAchieve		
        this.txtzpAchieve.setVisible(true);		
        this.txtzpAchieve.setHorizontalAlignment(2);		
        this.txtzpAchieve.setDataType(1);		
        this.txtzpAchieve.setSupportedEmpty(true);		
        this.txtzpAchieve.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtzpAchieve.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtzpAchieve.setPrecision(10);		
        this.txtzpAchieve.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtempNumber,txtempName,txtclinicNumber,txtclinicName,txtzxAchieve,txtbusinessDate,txtcityNumber,txtcityName,prmtcity,txtallGenAchieve,prmtclinic,txtzpAchieve}));
    ...
    public void initUIContentLayout()
    {
        ...
        contclinicNumber.setBounds(new Rectangle(10, 106, 270, 19));
        this.add(contclinicNumber, null);
        contclinicName.setBounds(new Rectangle(10, 82, 270, 19));
        this.add(contclinicName, null);
        contzxAchieve.setBounds(new Rectangle(10, 34, 270, 19));
        this.add(contzxAchieve, null);
        contbusinessDate.setBounds(new Rectangle(341, 34, 270, 19));
        this.add(contbusinessDate, null);
        contcityNumber.setBounds(new Rectangle(341, 82, 270, 19));
        ...
        contallGenAchieve.setBounds(new Rectangle(341, 106, 270, 19));
        this.add(contallGenAchieve, null);
        contclinic.setBounds(new Rectangle(672, 106, 270, 19));
        this.add(contclinic, null);
        contzpAchieve.setBounds(new Rectangle(10, 130, 270, 19));
        this.add(contzpAchieve, null);
        //kDLabelContainer1
        ...
        //contallGenAchieve
        contallGenAchieve.setBoundEditor(txtallGenAchieve);
        //contclinic
        contclinic.setBoundEditor(prmtclinic);
        //contzpAchieve
        contzpAchieve.setBoundEditor(txtzpAchieve);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("allGenAchieve", java.math.BigDecimal.class, this.txtallGenAchieve, "value");
		dataBinder.registerBinding("clinic", com.kingdee.eas.basedata.org.CompanyOrgUnitInfo.class, this.prmtclinic, "data");
		dataBinder.registerBinding("zpAchieve", java.math.BigDecimal.class, this.txtzpAchieve, "value");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ConsultantBonusUpdateEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.ConsultantBonusUpdateInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("allGenAchieve", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("clinic", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("zpAchieve", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("allGenAchieve"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
        ...
        sic.add(new SelectorItemInfo("zpAchieve"));
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ConsultantBonusUpdateEditUI");
    }
    ...
    {
        return com.kingdee.eas.mw.pay.client.ConsultantBonusUpdateEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.ConsultantBonusUpdateFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.ConsultantBonusUpdateInfo objectValue = new com.kingdee.eas.mw.pay.ConsultantBonusUpdateInfo();
