 ...
 * output class name
 */
public class AchieveDetailTemListUI extends AbstractAchieveDetailTemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AchieveDetailTemListUI.class);
    
    /**
     * output class constructor
     */
    public AchieveDetailTemListUI() throws Exception
    {
        super();
    }
