 ...
 * output class name
 */
public class DoctorCostsListUI extends AbstractDoctorCostsListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DoctorCostsListUI.class);
    
    /**
     * output class constructor
     */
    public DoctorCostsListUI() throws Exception
    {
        super();
    }
