 ...
 * output class name
 */
public abstract class AbstractBaoDiImpMoneyEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBaoDiImpMoneyEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contimpAchieve;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contimpCost;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contimpPro;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contbaodiType;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtimpAchieve;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtimpCost;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtimpPro;
    protected com.kingdee.bos.ctrl.swing.KDComboBox baodiType;
    protected com.kingdee.eas.mw.pay.BaoDiImpMoneyInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractBaoDiImpMoneyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBaoDiImpMoneyEditUI.class.getName());
        ...
        this.contimpAchieve = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contimpCost = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contimpPro = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contbaodiType = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtimpAchieve = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.txtimpCost = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.txtimpPro = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.baodiType = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.contimpAchieve.setName("contimpAchieve");
        this.contimpCost.setName("contimpCost");
        this.contimpPro.setName("contimpPro");
        this.contbaodiType.setName("contbaodiType");
        ...
        this.txtimpAchieve.setName("txtimpAchieve");
        this.txtimpCost.setName("txtimpCost");
        this.txtimpPro.setName("txtimpPro");
        this.baodiType.setName("baodiType");
        // CoreUI		
        ...
        // contimpAchieve		
        this.contimpAchieve.setBoundLabelText(resHelper.getString("contimpAchieve.boundLabelText"));		
        this.contimpAchieve.setBoundLabelLength(100);		
        this.contimpAchieve.setBoundLabelUnderline(true);		
        this.contimpAchieve.setVisible(true);
        // contimpCost		
        this.contimpCost.setBoundLabelText(resHelper.getString("contimpCost.boundLabelText"));		
        this.contimpCost.setBoundLabelLength(100);		
        this.contimpCost.setBoundLabelUnderline(true);		
        this.contimpCost.setVisible(true);
        // contimpPro		
        this.contimpPro.setBoundLabelText(resHelper.getString("contimpPro.boundLabelText"));		
        this.contimpPro.setBoundLabelLength(100);		
        this.contimpPro.setBoundLabelUnderline(true);		
        this.contimpPro.setVisible(true);
        // contbaodiType		
        this.contbaodiType.setBoundLabelText(resHelper.getString("contbaodiType.boundLabelText"));		
        this.contbaodiType.setBoundLabelLength(100);		
        this.contbaodiType.setBoundLabelUnderline(true);		
        this.contbaodiType.setVisible(true);
        // txtNumber		
        ...
        // txtimpAchieve		
        this.txtimpAchieve.setVisible(true);		
        this.txtimpAchieve.setHorizontalAlignment(2);		
        this.txtimpAchieve.setDataType(1);		
        this.txtimpAchieve.setSupportedEmpty(true);		
        this.txtimpAchieve.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtimpAchieve.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtimpAchieve.setPrecision(10);		
        this.txtimpAchieve.setRequired(false);
        // txtimpCost		
        this.txtimpCost.setVisible(true);		
        this.txtimpCost.setHorizontalAlignment(2);		
        this.txtimpCost.setDataType(1);		
        this.txtimpCost.setSupportedEmpty(true);		
        this.txtimpCost.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtimpCost.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtimpCost.setPrecision(10);		
        this.txtimpCost.setRequired(false);
        // txtimpPro		
        this.txtimpPro.setVisible(true);		
        this.txtimpPro.setHorizontalAlignment(2);		
        this.txtimpPro.setDataType(1);		
        this.txtimpPro.setSupportedEmpty(true);		
        this.txtimpPro.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtimpPro.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtimpPro.setPrecision(10);		
        this.txtimpPro.setRequired(false);
        // baodiType		
        this.baodiType.setVisible(true);		
        this.baodiType.addItems(EnumUtils.getEnumList("com.kingdee.eas.mw.pay.app.BaoDiType").toArray());		
        this.baodiType.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtempNumber,txtempName,txtclinicNumber,txtclinicName,txtbusinessDate,txtcityNumber,txtcityName,prmtcity,prmtclinic,txtimpAchieve,txtimpCost,txtimpPro,baodiType}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(672, 34, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(341, 34, 270, 19));
        ...
        contclinicNumber.setBounds(new Rectangle(672, 82, 270, 19));
        this.add(contclinicNumber, null);
        contclinicName.setBounds(new Rectangle(672, 58, 270, 19));
        this.add(contclinicName, null);
        contbusinessDate.setBounds(new Rectangle(10, 34, 270, 19));
        this.add(contbusinessDate, null);
        contcityNumber.setBounds(new Rectangle(10, 82, 270, 19));
        this.add(contcityNumber, null);
        contcityName.setBounds(new Rectangle(341, 82, 270, 19));
        this.add(contcityName, null);
        contcity.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contcity, null);
        contclinic.setBounds(new Rectangle(10, 106, 270, 19));
        this.add(contclinic, null);
        contimpAchieve.setBounds(new Rectangle(341, 106, 270, 19));
        this.add(contimpAchieve, null);
        contimpCost.setBounds(new Rectangle(672, 106, 270, 19));
        this.add(contimpCost, null);
        contimpPro.setBounds(new Rectangle(10, 130, 270, 19));
        this.add(contimpPro, null);
        contbaodiType.setBounds(new Rectangle(341, 130, 270, 19));
        this.add(contbaodiType, null);
        //kDLabelContainer1
        ...
        //contimpAchieve
        contimpAchieve.setBoundEditor(txtimpAchieve);
        //contimpCost
        contimpCost.setBoundEditor(txtimpCost);
        //contimpPro
        contimpPro.setBoundEditor(txtimpPro);
        //contbaodiType
        contbaodiType.setBoundEditor(baodiType);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("impAchieve", java.math.BigDecimal.class, this.txtimpAchieve, "value");
		dataBinder.registerBinding("impCost", java.math.BigDecimal.class, this.txtimpCost, "value");
		dataBinder.registerBinding("impPro", java.math.BigDecimal.class, this.txtimpPro, "value");
		dataBinder.registerBinding("baodiType", com.kingdee.eas.mw.pay.app.BaoDiType.class, this.baodiType, "selectedItem");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.BaoDiImpMoneyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.BaoDiImpMoneyInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("impAchieve", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("impCost", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("impPro", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("baodiType", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("impAchieve"));
        sic.add(new SelectorItemInfo("impCost"));
        sic.add(new SelectorItemInfo("impPro"));
        sic.add(new SelectorItemInfo("baodiType"));
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "BaoDiImpMoneyEditUI");
    }
    ...
    {
        return com.kingdee.eas.mw.pay.client.BaoDiImpMoneyEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.BaoDiImpMoneyFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.BaoDiImpMoneyInfo objectValue = new com.kingdee.eas.mw.pay.BaoDiImpMoneyInfo();
