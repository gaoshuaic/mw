 ...
 * output class name
 */
public class MarketDateListUI extends AbstractMarketDateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarketDateListUI.class);
    
    /**
     * output class constructor
     */
    public MarketDateListUI() throws Exception
    {
        super();
    }
