 ...
 * output class name
 */
public class AchieveDetailListUI extends AbstractAchieveDetailListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AchieveDetailListUI.class);
    
    /**
     * output class constructor
     */
    public AchieveDetailListUI() throws Exception
    {
        super();
    }
