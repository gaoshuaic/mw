 ...
 * output class name
 */
public class AchievementDetailListUI extends AbstractAchievementDetailListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AchievementDetailListUI.class);
    
    /**
     * output class constructor
     */
    public AchievementDetailListUI() throws Exception
    {
        super();
    }
