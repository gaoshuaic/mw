 ...
 * output class name
 */
public abstract class AbstractClinicAchieveUpdateEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractClinicAchieveUpdateEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contisClinic;
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox isClinic;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtclinic;
    protected com.kingdee.eas.mw.pay.ClinicAchieveUpdateInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractClinicAchieveUpdateEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractClinicAchieveUpdateEditUI.class.getName());
        ...
        this.contisClinic = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.isClinic = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.contisClinic.setName("contisClinic");
        ...
        this.isClinic.setName("isClinic");
        ...
        // contisClinic		
        this.contisClinic.setBoundLabelText(resHelper.getString("contisClinic.boundLabelText"));		
        this.contisClinic.setBoundLabelLength(100);		
        this.contisClinic.setBoundLabelUnderline(true);		
        this.contisClinic.setVisible(true);
        // contclinic		
        ...
        // isClinic		
        this.isClinic.setVisible(true);		
        this.isClinic.addItems(EnumUtils.getEnumList("com.kingdee.eas.mw.pay.app.CityOrClinic").toArray());		
        this.isClinic.setRequired(false);
        // prmtclinic		
        this.prmtclinic.setQueryInfo("com.kingdee.eas.basedata.org.app.AdminItemQuery");		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtclinicNumber,txtclinicName,txtclinicAchieve,txtincome,txtdiary,txtbusinessDate,isClinic,prmtclinic}));
    ...
    public void initUIContentLayout()
    {
        ...
        contclinicAchieve.setBounds(new Rectangle(341, 58, 270, 19));
        this.add(contclinicAchieve, null);
        contincome.setBounds(new Rectangle(672, 10, 270, 19));
        this.add(contincome, null);
        contdiary.setBounds(new Rectangle(10, 34, 270, 19));
        this.add(contdiary, null);
        contbusinessDate.setBounds(new Rectangle(341, 34, 270, 19));
        this.add(contbusinessDate, null);
        contisClinic.setBounds(new Rectangle(341, 82, 270, 19));
        this.add(contisClinic, null);
        contclinic.setBounds(new Rectangle(672, 82, 270, 19));
        ...
        //contisClinic
        contisClinic.setBoundEditor(isClinic);
        //contclinic
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("isClinic", com.kingdee.eas.mw.pay.app.CityOrClinic.class, this.isClinic, "selectedItem");
		dataBinder.registerBinding("clinic", com.kingdee.eas.basedata.org.AdminOrgUnitInfo.class, this.prmtclinic, "data");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ClinicAchieveUpdateEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.ClinicAchieveUpdateInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("isClinic", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("isClinic"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ClinicAchieveUpdateEditUI");
    }
    ...
    {
        return com.kingdee.eas.mw.pay.client.ClinicAchieveUpdateEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.ClinicAchieveUpdateFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.ClinicAchieveUpdateInfo objectValue = new com.kingdee.eas.mw.pay.ClinicAchieveUpdateInfo();
