 ...
 * output class name
 */
public class ClinicCostSumEditUI extends AbstractClinicCostSumEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ClinicCostSumEditUI.class);
    
    /**
     * output class constructor
     */
    public ClinicCostSumEditUI() throws Exception
    {
        super();
    }
    /**
