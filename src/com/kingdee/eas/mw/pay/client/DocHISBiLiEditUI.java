 ...
 * output class name
 */
public class DocHISBiLiEditUI extends AbstractDocHISBiLiEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DocHISBiLiEditUI.class);
    
    /**
     * output class constructor
     */
    public DocHISBiLiEditUI() throws Exception
    {
        super();
    }
    /**
