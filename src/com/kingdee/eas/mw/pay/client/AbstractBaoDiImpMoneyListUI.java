 ...
 * output class name
 */
public abstract class AbstractBaoDiImpMoneyListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBaoDiImpMoneyListUI.class);
    /**
     * output class constructor
     */
    public AbstractBaoDiImpMoneyListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.BaoDiImpMoneyListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "BaoDiImpMoneyListUI");
    }
