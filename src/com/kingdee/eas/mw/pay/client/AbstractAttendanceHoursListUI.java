 ...
 * output class name
 */
public abstract class AbstractAttendanceHoursListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttendanceHoursListUI.class);
     ...
     */
    public AbstractAttendanceHoursListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAttendanceHoursListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.mw.pay.app", "AttendanceHoursQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.AttendanceHoursListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("attrHours"));
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAttendanceHoursListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAttendanceHoursListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "AttendanceHoursListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.mw.pay.client.AttendanceHoursEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.AttendanceHoursFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.AttendanceHoursInfo objectValue = new com.kingdee.eas.mw.pay.AttendanceHoursInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","mzNumber","mzName","empNumber","empName","businessDate","attrHours","importDate"};
    }



	protected String getTDFileName() {
    	return "/bim/mw/pay/AttendanceHours";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.mw.pay.app.AttendanceHoursQuery");
	}
