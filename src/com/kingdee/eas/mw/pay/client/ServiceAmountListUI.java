 ...
 * output class name
 */
public class ServiceAmountListUI extends AbstractServiceAmountListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ServiceAmountListUI.class);
    
    /**
     * output class constructor
     */
    public ServiceAmountListUI() throws Exception
    {
        super();
    }
