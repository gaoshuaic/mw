 ...
 * output class name
 */
public class ConsultantProListUI extends AbstractConsultantProListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ConsultantProListUI.class);
    
    /**
     * output class constructor
     */
    public ConsultantProListUI() throws Exception
    {
        super();
    }
    @Override
