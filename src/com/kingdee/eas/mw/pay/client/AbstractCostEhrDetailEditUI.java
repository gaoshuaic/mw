 ...
 * output class name
 */
public abstract class AbstractCostEhrDetailEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCostEhrDetailEditUI.class);
    ...
    protected com.kingdee.eas.mw.pay.CostEhrDetailInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCostEhrDetailEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCostEhrDetailEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 994, 389));
        this.setLayout(null);
        contCreator.setBounds(new Rectangle(658, 298, 270, 19));
        this.add(contCreator, null);
        contCreateTime.setBounds(new Rectangle(658, 322, 270, 19));
        this.add(contCreateTime, null);
        contLastUpdateUser.setBounds(new Rectangle(334, 346, 270, 19));
        this.add(contLastUpdateUser, null);
        contLastUpdateTime.setBounds(new Rectangle(334, 298, 270, 19));
        this.add(contLastUpdateTime, null);
        contNumber.setBounds(new Rectangle(334, 322, 270, 19));
        this.add(contNumber, null);
        contBizDate.setBounds(new Rectangle(658, 346, 270, 19));
        this.add(contBizDate, null);
        contDescription.setBounds(new Rectangle(10, 322, 270, 19));
        ...
        contCaseNumber.setBounds(new Rectangle(658, 34, 270, 19));
        ...
        contName.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(contName, null);
        contFirSource.setBounds(new Rectangle(10, 82, 270, 19));
        this.add(contFirSource, null);
        contSecSource.setBounds(new Rectangle(334, 82, 270, 19));
        this.add(contSecSource, null);
        contTerSource.setBounds(new Rectangle(658, 82, 270, 19));
        this.add(contTerSource, null);
        contComplainNumber.setBounds(new Rectangle(334, 58, 270, 19));
        this.add(contComplainNumber, null);
        contComplainName.setBounds(new Rectangle(658, 58, 270, 19));
        this.add(contComplainName, null);
        contFirVis.setBounds(new Rectangle(10, 106, 270, 19));
        this.add(contFirVis, null);
        contCreateOrg.setBounds(new Rectangle(334, 106, 270, 19));
        this.add(contCreateOrg, null);
        contCreater.setBounds(new Rectangle(658, 106, 270, 19));
        this.add(contCreater, null);
        contStatus.setBounds(new Rectangle(10, 130, 270, 19));
        this.add(contStatus, null);
        contOrder.setBounds(new Rectangle(658, 130, 270, 19));
        this.add(contOrder, null);
        contRecDotNumber.setBounds(new Rectangle(334, 130, 270, 19));
        this.add(contRecDotNumber, null);
        contRecDotName.setBounds(new Rectangle(10, 154, 270, 19));
        this.add(contRecDotName, null);
        contNurseNUmber.setBounds(new Rectangle(334, 154, 270, 19));
        this.add(contNurseNUmber, null);
        contRecNurse.setBounds(new Rectangle(658, 154, 270, 19));
        this.add(contRecNurse, null);
        contNurseOrderDiag.setBounds(new Rectangle(10, 178, 270, 19));
        this.add(contNurseOrderDiag, null);
        contRecConNumber.setBounds(new Rectangle(334, 178, 270, 19));
        this.add(contRecConNumber, null);
        contRecConName.setBounds(new Rectangle(658, 178, 270, 19));
        this.add(contRecConName, null);
        contExcConNumber.setBounds(new Rectangle(10, 202, 270, 19));
        this.add(contExcConNumber, null);
        contExcConName.setBounds(new Rectangle(334, 202, 270, 19));
        this.add(contExcConName, null);
        contFirClassNumber.setBounds(new Rectangle(658, 202, 270, 19));
        this.add(contFirClassNumber, null);
        contFirClassName.setBounds(new Rectangle(10, 226, 270, 19));
        ...
        contFeeItemDetail.setBounds(new Rectangle(10, 250, 270, 19));
        this.add(contFeeItemDetail, null);
        contRecPerson.setBounds(new Rectangle(658, 250, 270, 19));
        this.add(contRecPerson, null);
        contQty.setBounds(new Rectangle(10, 274, 270, 19));
        this.add(contQty, null);
        contcityNumber.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contcityNumber, null);
        contfeeItemDetailNumber.setBounds(new Rectangle(334, 250, 270, 19));
        this.add(contfeeItemDetailNumber, null);
        contisRoutine.setBounds(new Rectangle(658, 274, 270, 19));
        this.add(contisRoutine, null);
        conthisOrderId.setBounds(new Rectangle(10, 298, 270, 19));
        this.add(conthisOrderId, null);
        contcost.setBounds(new Rectangle(334, 274, 270, 19));
        this.add(contcost, null);
        contbusinessDate.setBounds(new Rectangle(658, 10, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.CostEhrDetailEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.CostEhrDetailInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "CostEhrDetailEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.mw.pay.client.CostEhrDetailEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.CostEhrDetailFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.CostEhrDetailInfo objectValue = new com.kingdee.eas.mw.pay.CostEhrDetailInfo();
    	...
    	return "/bim/mw/pay/CostEhrDetail";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.mw.pay.app.CostEhrDetailQuery");
	}
