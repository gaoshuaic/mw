 ...
 * output class name
 */
public abstract class AbstractDocAchieveUpdateListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDocAchieveUpdateListUI.class);
    /**
     * output class constructor
     */
    public AbstractDocAchieveUpdateListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.DocAchieveUpdateListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "DocAchieveUpdateListUI");
    }
