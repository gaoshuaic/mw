 ...
 * output class name
 */
public class HolderDataSourceListUI extends AbstractHolderDataSourceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HolderDataSourceListUI.class);
    
    /**
     * output class constructor
     */
    public HolderDataSourceListUI() throws Exception
    {
        super();
    }
