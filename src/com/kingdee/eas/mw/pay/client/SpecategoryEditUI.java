 ...
 * output class name
 */
public class SpecategoryEditUI extends AbstractSpecategoryEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SpecategoryEditUI.class);
    
    /**
     * output class constructor
     */
    public SpecategoryEditUI() throws Exception
    {
        super();
    }
    /**
