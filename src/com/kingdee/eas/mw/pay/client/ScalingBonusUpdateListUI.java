 ...
 * output class name
 */
public class ScalingBonusUpdateListUI extends AbstractScalingBonusUpdateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ScalingBonusUpdateListUI.class);
    
    /**
     * output class constructor
     */
    public ScalingBonusUpdateListUI() throws Exception
    {
        super();
    }
