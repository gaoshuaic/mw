 ...
 * output class name
 */
public class PaySheetDetailEditUI extends AbstractPaySheetDetailEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PaySheetDetailEditUI.class);
    
    /**
     * output class constructor
     */
    public PaySheetDetailEditUI() throws Exception
    {
        super();
    }
    /**
