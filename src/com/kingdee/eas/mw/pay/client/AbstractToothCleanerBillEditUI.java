 ...
 * output class name
 */
public abstract class AbstractToothCleanerBillEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractToothCleanerBillEditUI.class);
    ...
    protected com.kingdee.eas.mw.pay.ToothCleanerBillInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractToothCleanerBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractToothCleanerBillEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtempNumber,txtempName,txtamount,txtbusinessDate}));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ToothCleanerBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.ToothCleanerBillInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ToothCleanerBillEditUI");
    }
