 ...
 * output class name
 */
public class ServiceAmountEditUI extends AbstractServiceAmountEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ServiceAmountEditUI.class);
    
    /**
     * output class constructor
     */
    public ServiceAmountEditUI() throws Exception
    {
        super();
    }
    /**
