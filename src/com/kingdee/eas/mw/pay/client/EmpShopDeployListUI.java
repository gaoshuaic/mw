 ...
 * output class name
 */
public class EmpShopDeployListUI extends AbstractEmpShopDeployListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EmpShopDeployListUI.class);
    
    /**
     * output class constructor
     */
    public EmpShopDeployListUI() throws Exception
    {
        super();
    }
    @Override
