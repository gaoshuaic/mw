 ...
 * output class name
 */
public class DianpingDedBJListUI extends AbstractDianpingDedBJListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DianpingDedBJListUI.class);
    
    /**
     * output class constructor
     */
    public DianpingDedBJListUI() throws Exception
    {
        super();
    }
