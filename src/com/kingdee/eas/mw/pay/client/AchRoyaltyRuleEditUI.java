 ...
 * output class name
 */
public class AchRoyaltyRuleEditUI extends AbstractAchRoyaltyRuleEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AchRoyaltyRuleEditUI.class);
    
    /**
     * output class constructor
     */
    public AchRoyaltyRuleEditUI() throws Exception
    {
        super();
    }
    /**
