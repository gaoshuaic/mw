 ...
 * output class name
 */
public abstract class AbstractCommentMessageEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCommentMessageEditUI.class);
    ...
    protected com.kingdee.eas.mw.pay.CommentMessageInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCommentMessageEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCommentMessageEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtmzNumber,txtmzName,txtbadNum,pkimportDate,txtbusinessDate,prmtcity,txtempNumber,txtempName}));
    ...
    public void initUIContentLayout()
    {
        ...
        contempNumber.setBounds(new Rectangle(672, 106, 270, 19));
        this.add(contempNumber, null);
        contempName.setBounds(new Rectangle(10, 130, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.CommentMessageEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.CommentMessageInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "CommentMessageEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.mw.pay.client.CommentMessageEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.CommentMessageFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.CommentMessageInfo objectValue = new com.kingdee.eas.mw.pay.CommentMessageInfo();
    	...
    	return "/bim/mw/pay/CommentMessage";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.mw.pay.app.CommentMessageQuery");
	}
