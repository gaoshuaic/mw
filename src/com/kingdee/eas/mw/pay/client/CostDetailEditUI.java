 ...
 * output class name
 */
public class CostDetailEditUI extends AbstractCostDetailEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CostDetailEditUI.class);
    
    /**
     * output class constructor
     */
    public CostDetailEditUI() throws Exception
    {
        super();
    }
    /**
