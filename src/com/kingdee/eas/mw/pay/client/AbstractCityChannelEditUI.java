 ...
 * output class name
 */
public abstract class AbstractCityChannelEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCityChannelEditUI.class);
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer1;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer2;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer3;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer4;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contcity;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contchannelType;
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkincludezx;
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkincludedoc;
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox channelType;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtchannel;
    ...
    protected com.kingdee.eas.mw.pay.CityChannelInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCityChannelEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCityChannelEditUI.class.getName());
        ...
        this.contchannelType = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.chkincludezx = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        this.chkincludedoc = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.channelType = new com.kingdee.bos.ctrl.swing.KDComboBox();
        this.txtchannel = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.contchannelType.setName("contchannelType");
        this.contchannel.setName("contchannel");
        this.contdiscount.setName("contdiscount");
        this.chkincludezx.setName("chkincludezx");
        this.chkincludedoc.setName("chkincludedoc");
        ...
        this.channelType.setName("channelType");
        this.txtchannel.setName("txtchannel");
        ...
        // contchannelType		
        this.contchannelType.setBoundLabelText(resHelper.getString("contchannelType.boundLabelText"));		
        this.contchannelType.setBoundLabelLength(100);		
        this.contchannelType.setBoundLabelUnderline(true);		
        this.contchannelType.setVisible(true);
        // contchannel		
        ...
        // chkincludezx		
        this.chkincludezx.setText(resHelper.getString("chkincludezx.text"));		
        this.chkincludezx.setHorizontalAlignment(2);
        // chkincludedoc		
        this.chkincludedoc.setText(resHelper.getString("chkincludedoc.text"));		
        this.chkincludedoc.setHorizontalAlignment(2);
        // contbusinessDate		
        ...
        // channelType		
        this.channelType.addItems(EnumUtils.getEnumList("com.kingdee.eas.mw.pay.app.ChannelTypeEnum").toArray());		
        this.channelType.setRequired(false);
        // txtchannel		
        this.txtchannel.setHorizontalAlignment(2);		
        this.txtchannel.setMaxLength(250);		
        this.txtchannel.setRequired(false);
        // txtdiscount		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtName,txtNumber,txtDescription,txtSimpleName,prmtcity,channelType,txtbusinessDate,txtchannel,txtdiscount,chkincludezx,chkincludedoc}));
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer4.setBounds(new Rectangle(672, 82, 270, 19));
        this.add(kDLabelContainer4, null);
        contcity.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contcity, null);
        contchannelType.setBounds(new Rectangle(341, 10, 270, 19));
        this.add(contchannelType, null);
        contchannel.setBounds(new Rectangle(10, 34, 602, 19));
        this.add(contchannel, null);
        contdiscount.setBounds(new Rectangle(672, 34, 270, 19));
        this.add(contdiscount, null);
        chkincludezx.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(chkincludezx, null);
        chkincludedoc.setBounds(new Rectangle(341, 58, 270, 19));
        this.add(chkincludedoc, null);
        ...
        //contchannelType
        contchannelType.setBoundEditor(channelType);
        //contchannel
        contchannel.setBoundEditor(txtchannel);
        //contdiscount
	...
	private void registerBindings(){
		dataBinder.registerBinding("includezx", boolean.class, this.chkincludezx, "selected");
		dataBinder.registerBinding("includedoc", boolean.class, this.chkincludedoc, "selected");
		...
		dataBinder.registerBinding("channelType", com.kingdee.eas.mw.pay.app.ChannelTypeEnum.class, this.channelType, "selectedItem");
		dataBinder.registerBinding("channel", String.class, this.txtchannel, "text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.CityChannelEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.CityChannelInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("includezx", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("includedoc", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("number", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("name", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("simpleName", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("description", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("city", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("channelType", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("includezx"));
        sic.add(new SelectorItemInfo("includedoc"));
        ...
        sic.add(new SelectorItemInfo("channelType"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "CityChannelEditUI");
    }
    ...
    {
        return com.kingdee.eas.mw.pay.client.CityChannelEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.CityChannelFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.CityChannelInfo objectValue = new com.kingdee.eas.mw.pay.CityChannelInfo();
