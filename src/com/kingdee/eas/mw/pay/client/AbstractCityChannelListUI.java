 ...
 * output class name
 */
public abstract class AbstractCityChannelListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCityChannelListUI.class);
    /**
     * output class constructor
     */
    public AbstractCityChannelListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.CityChannelListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "CityChannelListUI");
    }
