 ...
 * output class name
 */
public class AchieveDetailEditUI extends AbstractAchieveDetailEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AchieveDetailEditUI.class);
    
    /**
     * output class constructor
     */
    public AchieveDetailEditUI() throws Exception
    {
        super();
    }
    /**
