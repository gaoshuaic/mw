 ...
 * output class name
 */
public class AchievementDetailEditUI extends AbstractAchievementDetailEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AchievementDetailEditUI.class);
    
    /**
     * output class constructor
     */
    public AchievementDetailEditUI() throws Exception
    {
        super();
    }
    /**
