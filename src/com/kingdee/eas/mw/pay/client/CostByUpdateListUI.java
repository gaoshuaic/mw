 ...
 * output class name
 */
public class CostByUpdateListUI extends AbstractCostByUpdateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CostByUpdateListUI.class);
    
    /**
     * output class constructor
     */
    public CostByUpdateListUI() throws Exception
    {
        super();
    }
