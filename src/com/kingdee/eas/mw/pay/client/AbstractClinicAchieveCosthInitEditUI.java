 ...
 * output class name
 */
public abstract class AbstractClinicAchieveCosthInitEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractClinicAchieveCosthInitEditUI.class);
    ...
    protected com.kingdee.eas.mw.pay.ClinicAchieveCosthInitInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractClinicAchieveCosthInitEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractClinicAchieveCosthInitEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 1013, 398));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(341, 322, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(341, 298, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(672, 298, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(10, 322, 270, 19));
        ...
        contwhiteAchieve.setBounds(new Rectangle(10, 82, 270, 19));
        this.add(contwhiteAchieve, null);
        contzxAchieve.setBounds(new Rectangle(341, 82, 270, 19));
        this.add(contzxAchieve, null);
        contzzAchieve.setBounds(new Rectangle(10, 106, 270, 19));
        this.add(contzzAchieve, null);
        contzzCost.setBounds(new Rectangle(341, 106, 270, 19));
        this.add(contzzCost, null);
        contgdjzAchieve.setBounds(new Rectangle(672, 82, 270, 19));
        this.add(contgdjzAchieve, null);
        contgdjzCost.setBounds(new Rectangle(672, 106, 270, 19));
        this.add(contgdjzCost, null);
        contyxjzAchieve.setBounds(new Rectangle(10, 130, 270, 19));
        this.add(contyxjzAchieve, null);
        contyxjzCost.setBounds(new Rectangle(341, 130, 270, 19));
        this.add(contyxjzCost, null);
        contzyAchieve.setBounds(new Rectangle(672, 130, 270, 19));
        this.add(contzyAchieve, null);
        contyzCost.setBounds(new Rectangle(10, 154, 270, 19));
        this.add(contyzCost, null);
        contknwAchieve.setBounds(new Rectangle(672, 154, 270, 19));
        this.add(contknwAchieve, null);
        contknwCost.setBounds(new Rectangle(341, 154, 270, 19));
        this.add(contknwCost, null);
        contmbAchieve.setBounds(new Rectangle(10, 178, 270, 19));
        this.add(contmbAchieve, null);
        contmbCost.setBounds(new Rectangle(341, 178, 270, 19));
        this.add(contmbCost, null);
        contxfAchieve.setBounds(new Rectangle(672, 178, 270, 19));
        this.add(contxfAchieve, null);
        contxfCost.setBounds(new Rectangle(10, 202, 270, 19));
        this.add(contxfCost, null);
        conteyAchieve.setBounds(new Rectangle(672, 202, 270, 19));
        this.add(conteyAchieve, null);
        conteyCost.setBounds(new Rectangle(341, 202, 270, 19));
        this.add(conteyCost, null);
        contsumAchieve.setBounds(new Rectangle(10, 226, 270, 19));
        this.add(contsumAchieve, null);
        contzzMoney.setBounds(new Rectangle(341, 226, 270, 19));
        this.add(contzzMoney, null);
        contgdjzMoney.setBounds(new Rectangle(672, 226, 270, 19));
        this.add(contgdjzMoney, null);
        contyxjzMoney.setBounds(new Rectangle(10, 250, 270, 19));
        this.add(contyxjzMoney, null);
        contknwMoney.setBounds(new Rectangle(672, 250, 270, 19));
        this.add(contknwMoney, null);
        contyzMoney.setBounds(new Rectangle(341, 250, 270, 19));
        this.add(contyzMoney, null);
        contmbMoney.setBounds(new Rectangle(10, 274, 270, 19));
        this.add(contmbMoney, null);
        contxfMoney.setBounds(new Rectangle(341, 274, 270, 19));
        this.add(contxfMoney, null);
        conteyMoney.setBounds(new Rectangle(672, 274, 270, 19));
        this.add(conteyMoney, null);
        contotherMoney.setBounds(new Rectangle(10, 298, 270, 19));
        this.add(contotherMoney, null);
        contpostType.setBounds(new Rectangle(672, 322, 270, 19));
        this.add(contpostType, null);
        chkiszidai.setBounds(new Rectangle(18, 358, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ClinicAchieveCosthInitEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.ClinicAchieveCosthInitInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ClinicAchieveCosthInitEditUI");
    }
