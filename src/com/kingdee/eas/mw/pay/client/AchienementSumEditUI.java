 ...
 * output class name
 */
public class AchienementSumEditUI extends AbstractAchienementSumEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AchienementSumEditUI.class);
    
    /**
     * output class constructor
     */
    public AchienementSumEditUI() throws Exception
    {
        super();
    }
    /**
