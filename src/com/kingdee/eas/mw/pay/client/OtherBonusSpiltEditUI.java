 ...
 * output class name
 */
public class OtherBonusSpiltEditUI extends AbstractOtherBonusSpiltEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(OtherBonusSpiltEditUI.class);
    
    /**
     * output class constructor
     */
    public OtherBonusSpiltEditUI() throws Exception
    {
        super();
    }
    /**
