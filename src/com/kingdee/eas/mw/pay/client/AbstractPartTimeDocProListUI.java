 ...
 * output class name
 */
public abstract class AbstractPartTimeDocProListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPartTimeDocProListUI.class);
    /**
     * output class constructor
     */
    public AbstractPartTimeDocProListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.PartTimeDocProListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "PartTimeDocProListUI");
    }
