 ...
 * output class name
 */
public class DoctorRelationListUI extends AbstractDoctorRelationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DoctorRelationListUI.class);
    
    /**
     * output class constructor
     */
    public DoctorRelationListUI() throws Exception
    {
        super();
    }
    @Override
