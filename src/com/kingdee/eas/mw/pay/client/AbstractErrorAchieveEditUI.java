 ...
 * output class name
 */
public abstract class AbstractErrorAchieveEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractErrorAchieveEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer conthisorderDetailid;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contitemNumber;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txthisorderDetailid;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtitemNumber;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtitemName;
    protected com.kingdee.eas.mw.pay.ErrorAchieveInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractErrorAchieveEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractErrorAchieveEditUI.class.getName());
        ...
        this.conthisorderDetailid = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contitemNumber = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txthisorderDetailid = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.txtitemNumber = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.conthisorderDetailid.setName("conthisorderDetailid");
        this.contitemNumber.setName("contitemNumber");
        ...
        this.txthisorderDetailid.setName("txthisorderDetailid");
        this.txtitemNumber.setName("txtitemNumber");
        ...
        // conthisorderDetailid		
        this.conthisorderDetailid.setBoundLabelText(resHelper.getString("conthisorderDetailid.boundLabelText"));		
        this.conthisorderDetailid.setBoundLabelLength(100);		
        this.conthisorderDetailid.setBoundLabelUnderline(true);		
        this.conthisorderDetailid.setVisible(true);
        // contitemNumber		
        this.contitemNumber.setBoundLabelText(resHelper.getString("contitemNumber.boundLabelText"));		
        this.contitemNumber.setBoundLabelLength(100);		
        this.contitemNumber.setBoundLabelUnderline(true);		
        this.contitemNumber.setVisible(true);
        // contitemName		
        ...
        // txthisorderDetailid		
        this.txthisorderDetailid.setVisible(true);		
        this.txthisorderDetailid.setHorizontalAlignment(2);		
        this.txthisorderDetailid.setMaxLength(100);		
        this.txthisorderDetailid.setRequired(false);
        // txtitemNumber		
        this.txtitemNumber.setVisible(true);		
        this.txtitemNumber.setHorizontalAlignment(2);		
        this.txtitemNumber.setMaxLength(100);		
        this.txtitemNumber.setRequired(false);
        // txtitemName		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtclinicNumber,txtclinicName,txtbusinessDate,prmtcity,prmtclinic,txtsaleoutNumber,txthisorderid,txthisorderDetailid,txtitemNumber,txtitemName}));
    ...
    public void initUIContentLayout()
    {
        ...
        contclinicName.setBounds(new Rectangle(672, 82, 270, 19));
        ...
        contsaleoutNumber.setBounds(new Rectangle(10, 34, 270, 19));
        this.add(contsaleoutNumber, null);
        conthisorderid.setBounds(new Rectangle(341, 34, 270, 19));
        this.add(conthisorderid, null);
        conthisorderDetailid.setBounds(new Rectangle(672, 34, 270, 19));
        this.add(conthisorderDetailid, null);
        contitemNumber.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(contitemNumber, null);
        contitemName.setBounds(new Rectangle(341, 58, 270, 19));
        ...
        //conthisorderDetailid
        conthisorderDetailid.setBoundEditor(txthisorderDetailid);
        //contitemNumber
        contitemNumber.setBoundEditor(txtitemNumber);
        //contitemName
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("hisorderDetailid", String.class, this.txthisorderDetailid, "text");
		dataBinder.registerBinding("itemNumber", String.class, this.txtitemNumber, "text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ErrorAchieveEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.txtclinicNumber.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.pay.ErrorAchieveInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("hisorderDetailid", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("itemNumber", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("hisorderDetailid"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ErrorAchieveEditUI");
    }
    ...
    {
        return com.kingdee.eas.mw.pay.client.ErrorAchieveEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.pay.ErrorAchieveFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.pay.ErrorAchieveInfo objectValue = new com.kingdee.eas.mw.pay.ErrorAchieveInfo();
