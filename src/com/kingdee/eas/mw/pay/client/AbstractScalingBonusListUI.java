 ...
 * output class name
 */
public abstract class AbstractScalingBonusListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScalingBonusListUI.class);
    /**
     * output class constructor
     */
    public AbstractScalingBonusListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ScalingBonusListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ScalingBonusListUI");
    }
