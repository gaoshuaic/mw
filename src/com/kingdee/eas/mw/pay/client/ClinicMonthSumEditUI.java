 ...
 * output class name
 */
public class ClinicMonthSumEditUI extends AbstractClinicMonthSumEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ClinicMonthSumEditUI.class);
    
    /**
     * output class constructor
     */
    public ClinicMonthSumEditUI() throws Exception
    {
        super();
    }
    /**
