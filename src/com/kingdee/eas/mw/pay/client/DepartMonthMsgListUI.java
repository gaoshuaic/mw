 ...
 * output class name
 */
public class DepartMonthMsgListUI extends AbstractDepartMonthMsgListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DepartMonthMsgListUI.class);
    
    /**
     * output class constructor
     */
    public DepartMonthMsgListUI() throws Exception
    {
        super();
    }
