 ...
 * output class name
 */
public abstract class AbstractErrorAchieveListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractErrorAchieveListUI.class);
    /**
     * output class constructor
     */
    public AbstractErrorAchieveListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.pay.app.ErrorAchieveListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.pay.client", "ErrorAchieveListUI");
    }
