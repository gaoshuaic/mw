 ...
 * output class name
 */
public class SpecategoryListUI extends AbstractSpecategoryListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SpecategoryListUI.class);
    
    /**
     * output class constructor
     */
    public SpecategoryListUI() throws Exception
    {
        super();
    }
