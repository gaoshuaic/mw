 ...
 * output class name
 */
public class CostDetailListUI extends AbstractCostDetailListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CostDetailListUI.class);
    
    /**
     * output class constructor
     */
    public CostDetailListUI() throws Exception
    {
        super();
    }
	...
	protected FilterInfo getDefaultFilterForQuery() {
         ...
         //AdminOrgUnitInfo dept = SaleIssueSyncTool.getDepartment( userid);
         ...
         try {
             ...
             if(flagOrg){
                 ...
                 if(!flag){//只能查看自己的
              	   	 filter.getFilterItems().add(new FilterItemInfo("CITYNUMBER",number )); 
