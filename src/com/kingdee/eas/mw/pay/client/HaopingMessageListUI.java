 ...
 * output class name
 */
public class HaopingMessageListUI extends AbstractHaopingMessageListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HaopingMessageListUI.class);
    
    /**
     * output class constructor
     */
    public HaopingMessageListUI() throws Exception
    {
        super();
    }
