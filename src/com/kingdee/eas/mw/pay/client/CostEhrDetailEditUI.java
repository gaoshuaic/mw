 ...
 * output class name
 */
public class CostEhrDetailEditUI extends AbstractCostEhrDetailEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CostEhrDetailEditUI.class);
    
    /**
     * output class constructor
     */
    public CostEhrDetailEditUI() throws Exception
    {
        super();
    }
    /**
