...
public class CostCenterE1 extends CoreBillEntryBase implements ICostCenterE1
{
    public CostCenterE1()
    {
        super();
        registerInterface(ICostCenterE1.class, this);
    }
    public CostCenterE1(Context ctx)
    {
        super(ctx);
        registerInterface(ICostCenterE1.class, this);
    }
    ...
    private CostCenterE1Controller getController() throws BOSException
    {
        return (CostCenterE1Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCostCenterE1Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostCenterE1Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostCenterE1Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostCenterE1Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostCenterE1Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostCenterE1Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
