 ...
 * output class name
 */
public class ClinicItemListUI extends AbstractClinicItemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ClinicItemListUI.class);
    
    /**
     * output class constructor
     */
    public ClinicItemListUI() throws Exception
    {
        super();
    }
