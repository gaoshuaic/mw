 ...
 * output class name
 */
public class ItemCheckListUI extends AbstractItemCheckListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ItemCheckListUI.class);
    
    /**
     * output class constructor
     */
    public ItemCheckListUI() throws Exception
    {
        super();
    }
	...
	protected FilterInfo getDefaultFilterForQuery() {
         ...
         //filter.getFilterItems().add(new FilterItemInfo("TYPENUMBER","'ZZ','ZJ','XF','EY','KNW','YZ','YX','GD','EY','CG'",CompareType.NOTINNER ));   
         return filter;
	}
