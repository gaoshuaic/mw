 ...
 * output class name
 */
public abstract class AbstractItemCityEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractItemCityEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtitem;
    protected com.kingdee.eas.mw.srqr.ItemCityInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractItemCityEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractItemCityEditUI.class.getName());
        ...
        this.txtitem = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.txtitem.setHorizontalAlignment(2);		
        this.txtitem.setMaxLength(100);		
        this.txtitem.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtclinicNumber,txtcity,txtitem}));
    ...
    public void initUIContentLayout()
    {
        ...
        contclinicNumber.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(contclinicNumber, null);
        contcity.setBounds(new Rectangle(341, 34, 270, 19));
        this.add(contcity, null);
        contitem.setBounds(new Rectangle(672, 34, 270, 19));
        this.add(contitem, null);
        //kDLabelContainer1
        ...
        //contitem
        contitem.setBoundEditor(txtitem);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("item", String.class, this.txtitem, "text");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.srqr.app.ItemCityEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.srqr.ItemCityInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.srqr.client", "ItemCityEditUI");
    }
    ...
    {
        return com.kingdee.eas.mw.srqr.client.ItemCityEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.srqr.ItemCityFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.srqr.ItemCityInfo objectValue = new com.kingdee.eas.mw.srqr.ItemCityInfo();
