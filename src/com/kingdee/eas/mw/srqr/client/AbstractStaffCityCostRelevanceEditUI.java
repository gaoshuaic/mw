 ...
 * output class name
 */
public abstract class AbstractStaffCityCostRelevanceEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractStaffCityCostRelevanceEditUI.class);
    ...
    protected com.kingdee.eas.mw.srqr.StaffCityCostRelevanceInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractStaffCityCostRelevanceEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractStaffCityCostRelevanceEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtPerson,prmtcity,prmtPostType,txtperiod,prmtCostCenter}));
    ...
    public void initUIContentLayout()
    {
        ...
        contPerson.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(contPerson, null);
        contPostType.setBounds(new Rectangle(341, 10, 270, 19));
        this.add(contPostType, null);
        contcity.setBounds(new Rectangle(341, 58, 270, 19));
        this.add(contcity, null);
        contperiod.setBounds(new Rectangle(672, 58, 270, 19));
        this.add(contperiod, null);
        contCostCenter.setBounds(new Rectangle(10, 10, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.srqr.app.StaffCityCostRelevanceEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.srqr.StaffCityCostRelevanceInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.srqr.client", "StaffCityCostRelevanceEditUI");
    }
