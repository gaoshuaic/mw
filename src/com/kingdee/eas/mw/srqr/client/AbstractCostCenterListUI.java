 ...
 * output class name
 */
public abstract class AbstractCostCenterListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCostCenterListUI.class);
    /**
     * output class constructor
     */
    public AbstractCostCenterListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.srqr.app.CostCenterListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("E1.empType.name"));
        return sic;
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.srqr.client", "CostCenterListUI");
    }
    ...
    {
        return com.kingdee.eas.mw.srqr.client.CostCenterEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.srqr.CostCenterFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.srqr.CostCenterInfo objectValue = new com.kingdee.eas.mw.srqr.CostCenterInfo();		
        return objectValue;
    }
