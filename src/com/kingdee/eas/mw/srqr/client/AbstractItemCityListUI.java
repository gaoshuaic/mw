 ...
 * output class name
 */
public abstract class AbstractItemCityListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractItemCityListUI.class);
    /**
     * output class constructor
     */
    public AbstractItemCityListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.srqr.app.ItemCityListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.srqr.client", "ItemCityListUI");
    }
