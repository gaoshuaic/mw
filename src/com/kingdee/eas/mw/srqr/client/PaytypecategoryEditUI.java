 ...
 * output class name
 */
public class PaytypecategoryEditUI extends AbstractPaytypecategoryEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PaytypecategoryEditUI.class);
    
    /**
     * output class constructor
     */
    public PaytypecategoryEditUI() throws Exception
    {
        super();
    }
    /**
