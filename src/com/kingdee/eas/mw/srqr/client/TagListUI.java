 ...
 * output class name
 */
public class TagListUI extends AbstractTagListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TagListUI.class);
    
    /**
     * output class constructor
     */
    public TagListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.mw.srqr.client.TagTreeEditUI.class.getName();
    }
