 ...
 * output class name
 */
public class FenTanAchieveListUI extends AbstractFenTanAchieveListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FenTanAchieveListUI.class);
    
    /**
     * output class constructor
     */
    public FenTanAchieveListUI() throws Exception
    {
        super();
    }
