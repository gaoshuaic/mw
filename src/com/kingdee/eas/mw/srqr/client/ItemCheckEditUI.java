 ...
 * output class name
 */
public class ItemCheckEditUI extends AbstractItemCheckEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ItemCheckEditUI.class);
    
    /**
     * output class constructor
     */
    public ItemCheckEditUI() throws Exception
    {
        super();
    }
    /**
