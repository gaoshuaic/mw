 ...
 * output class name
 */
public abstract class AbstractPayItemListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPayItemListUI.class);
    /**
     * output class constructor
     */
    public AbstractPayItemListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.srqr.app.PayItemListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.srqr.client", "PayItemListUI");
    }
