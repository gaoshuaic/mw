 ...
 * output class name
 */
public abstract class AbstractTagListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTagListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractTagListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractTagListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.srqr.app.TagListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.srqr.client", "TagListUI");
    }
    ...
    {
        return com.kingdee.eas.mw.srqr.client.TagEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.srqr.TagFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.srqr.TagInfo objectValue = new com.kingdee.eas.mw.srqr.TagInfo();		
        return objectValue;
    }
