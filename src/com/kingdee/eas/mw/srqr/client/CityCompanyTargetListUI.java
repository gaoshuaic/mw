 ...
 * output class name
 */
public class CityCompanyTargetListUI extends AbstractCityCompanyTargetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CityCompanyTargetListUI.class);
    
    /**
     * output class constructor
     */
    public CityCompanyTargetListUI() throws Exception
    {
        super();
    }
