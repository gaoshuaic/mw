 ...
 * output class name
 */
public abstract class AbstractPostTypeListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPostTypeListUI.class);
    /**
     * output class constructor
     */
    public AbstractPostTypeListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.srqr.app.PostTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.srqr.client", "PostTypeListUI");
    }
