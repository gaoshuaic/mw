 ...
 * output class name
 */
public abstract class AbstractPaytypeitemListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPaytypeitemListUI.class);
    /**
     * output class constructor
     */
    public AbstractPaytypeitemListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.srqr.app.PaytypeitemListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.srqr.client", "PaytypeitemListUI");
    }
