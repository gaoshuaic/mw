 ...
 * output class name
 */
public class FreeItemCheckListUI extends AbstractFreeItemCheckListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FreeItemCheckListUI.class);
    
    /**
     * output class constructor
     */
    public FreeItemCheckListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.mw.srqr.client.FreeItemCheckTreeEditUI.class.getName();
    }
