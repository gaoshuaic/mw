 ...
 * output class name
 */
public class SpecialItemListUI extends AbstractSpecialItemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SpecialItemListUI.class);
    
    /**
     * output class constructor
     */
    public SpecialItemListUI() throws Exception
    {
        super();
    }
