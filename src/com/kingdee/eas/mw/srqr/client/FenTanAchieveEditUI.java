 ...
 * output class name
 */
public class FenTanAchieveEditUI extends AbstractFenTanAchieveEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(FenTanAchieveEditUI.class);
    
    /**
     * output class constructor
     */
    public FenTanAchieveEditUI() throws Exception
    {
        super();
    }
    /**
