 ...
 * output class name
 */
public abstract class AbstractCityMarketAchieveEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCityMarketAchieveEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contrelachieve;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contmarketdep;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtrelachieve;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtmarketdep;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtbusinessdate;
    protected com.kingdee.eas.mw.srqr.CityMarketAchieveInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCityMarketAchieveEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCityMarketAchieveEditUI.class.getName());
        ...
        this.contrelachieve = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contmarketdep = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtrelachieve = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.prmtmarketdep = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.contrelachieve.setName("contrelachieve");
        this.contmarketdep.setName("contmarketdep");
        ...
        this.txtrelachieve.setName("txtrelachieve");
        this.prmtmarketdep.setName("prmtmarketdep");
        ...
        // contrelachieve		
        this.contrelachieve.setBoundLabelText(resHelper.getString("contrelachieve.boundLabelText"));		
        this.contrelachieve.setBoundLabelLength(100);		
        this.contrelachieve.setBoundLabelUnderline(true);		
        this.contrelachieve.setVisible(true);
        // contmarketdep		
        this.contmarketdep.setBoundLabelText(resHelper.getString("contmarketdep.boundLabelText"));		
        this.contmarketdep.setBoundLabelLength(100);		
        this.contmarketdep.setBoundLabelUnderline(true);		
        this.contmarketdep.setVisible(true);
        // contbusinessdate		
        ...
        // txtrelachieve		
        this.txtrelachieve.setVisible(true);		
        this.txtrelachieve.setHorizontalAlignment(2);		
        this.txtrelachieve.setDataType(1);		
        this.txtrelachieve.setSupportedEmpty(true);		
        this.txtrelachieve.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtrelachieve.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtrelachieve.setPrecision(10);		
        this.txtrelachieve.setRequired(false);
        // prmtmarketdep		
        this.prmtmarketdep.setQueryInfo("com.kingdee.eas.mw.srqr.app.PostTypeQuery");		
        this.prmtmarketdep.setVisible(true);		
        this.prmtmarketdep.setEditable(true);		
        this.prmtmarketdep.setDisplayFormat("$name$");		
        this.prmtmarketdep.setEditFormat("$number$");		
        this.prmtmarketdep.setCommitFormat("$number$");		
        this.prmtmarketdep.setRequired(false);
        // txtbusinessdate		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtcity,txttarachieve,txtrelachieve,prmtmarketdep,txtbusinessdate}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 1013, 101));
        this.setLayout(null);
        ...
        conttarachieve.setBounds(new Rectangle(10, 34, 270, 19));
        this.add(conttarachieve, null);
        contrelachieve.setBounds(new Rectangle(341, 34, 270, 19));
        this.add(contrelachieve, null);
        contmarketdep.setBounds(new Rectangle(341, 10, 270, 19));
        this.add(contmarketdep, null);
        ...
        //contrelachieve
        contrelachieve.setBoundEditor(txtrelachieve);
        //contmarketdep
        contmarketdep.setBoundEditor(prmtmarketdep);
        //contbusinessdate
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("relachieve", java.math.BigDecimal.class, this.txtrelachieve, "value");
		dataBinder.registerBinding("marketdep", com.kingdee.eas.mw.srqr.PostTypeInfo.class, this.prmtmarketdep, "data");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.srqr.app.CityMarketAchieveEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mw.srqr.CityMarketAchieveInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("relachieve", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("marketdep", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("relachieve"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("marketdep.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("marketdep.id"));
        	sic.add(new SelectorItemInfo("marketdep.number"));
        	sic.add(new SelectorItemInfo("marketdep.name"));
		}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.srqr.client", "CityMarketAchieveEditUI");
    }
    ...
    {
        return com.kingdee.eas.mw.srqr.client.CityMarketAchieveEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.mw.srqr.CityMarketAchieveFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.mw.srqr.CityMarketAchieveInfo objectValue = new com.kingdee.eas.mw.srqr.CityMarketAchieveInfo();
