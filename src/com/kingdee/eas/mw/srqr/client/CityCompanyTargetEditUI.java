 ...
 * output class name
 */
public class CityCompanyTargetEditUI extends AbstractCityCompanyTargetEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CityCompanyTargetEditUI.class);
    
    /**
     * output class constructor
     */
    public CityCompanyTargetEditUI() throws Exception
    {
        super();
    }
    /**
