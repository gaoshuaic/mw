 ...
 * output class name
 */
public abstract class AbstractFenTanAchieveListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFenTanAchieveListUI.class);
    /**
     * output class constructor
     */
    public AbstractFenTanAchieveListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.srqr.app.FenTanAchieveListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.srqr.client", "FenTanAchieveListUI");
    }
