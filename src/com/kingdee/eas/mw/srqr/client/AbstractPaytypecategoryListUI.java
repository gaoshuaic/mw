 ...
 * output class name
 */
public abstract class AbstractPaytypecategoryListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPaytypecategoryListUI.class);
    /**
     * output class constructor
     */
    public AbstractPaytypecategoryListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mw.srqr.app.PaytypecategoryListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mw.srqr.client", "PaytypecategoryListUI");
    }
