...
public class FreeItemCheckEntry extends CoreBillEntryBase implements IFreeItemCheckEntry
{
    public FreeItemCheckEntry()
    {
        super();
        registerInterface(IFreeItemCheckEntry.class, this);
    }
    public FreeItemCheckEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IFreeItemCheckEntry.class, this);
    }
    ...
    private FreeItemCheckEntryController getController() throws BOSException
    {
        return (FreeItemCheckEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFreeItemCheckEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFreeItemCheckEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFreeItemCheckEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFreeItemCheckEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFreeItemCheckEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFreeItemCheckEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
