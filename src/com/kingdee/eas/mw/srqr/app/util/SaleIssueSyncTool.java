...
public class SaleIssueSyncTool {
	...
	private static List getCompanyAndPeriod(Context ctx){
	    ...
	    " and b.FIsSealUp = 0 and b.FIsBizUnit = 1 and to_char(FInvalidDate,'yyyyMMDD')='21991231' and b.fnumber like 'MS%' " ;
...
//							}
	...
	private static Map<String,String> getMaterialInfoByID(Context ctx,String billId){
		  Map<String,String> mp =null ;
		  String sql="select b.FNUMBER,b.CFPINGPAI as PP,b.CFHUOHAO as HH,b.FMODEL as GG,b.CFXINGHAO as XH " +
